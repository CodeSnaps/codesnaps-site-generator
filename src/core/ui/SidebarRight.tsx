...
export function ToolbarItem({
  ...
  const className = getToolbarItemClassBuilder()({
    collapsed,
    active,
  });
...
function getClassNameBuilder() {
  return cva(
    [
      'fixed flex box-content hidden h-screen flex-col border-l border-neutral-200 bg-background dark:border-dark-800 right-0 lg:flex ' +
...
function getToolbarItemClassBuilder() {
  return cva(
    [
