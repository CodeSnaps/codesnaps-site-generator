...
const AuthProviderButton: React.FCC<{
  ...
  return (
    <Button
      ...
      block
      variant={'custom'}
      className={`relative border border-neutral-200 text-neutral-600 ring-primary/70
        ring-offset-1 transition-all hover:border-neutral-300 hover:bg-neutral-50
        focus:ring-2 active:bg-neutral-100 dark:border-dark-700
        dark:bg-background/90 dark:text-neutral-200 dark:ring-primary/70
