...
function SidebarDraggableItem({ hasActiveSub }: { hasActiveSub: boolean }) {
  return (
    <SidebarItem
      ...
      image="https://ablcaocvmgtcodafwvoe.supabase.co/storage/v1/object/public/components/team_1-1699475022901.webp"
      name="Team 1"
      Component={Team1}
    />
  );
...
function prepForPageExport(
  ...
  importStatements.push(`import Team1 from './components/Team1';`);
  componentContent.push('<Team1 />');
  return zip.file('components/Team1.jsx', content);
}
