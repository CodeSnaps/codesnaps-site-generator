...
function SidebarDraggableItem({ hasActiveSub }: { hasActiveSub: boolean }) {
  return (
    <SidebarItem
      ...
      image="https://ablcaocvmgtcodafwvoe.supabase.co/storage/v1/object/public/components/team_4-1700175007216.webp"
      name="Team 4"
      Component={Team4}
    />
  );
...
function prepForPageExport(
  ...
  importStatements.push(`import Team4 from './components/Team4';`);
  componentContent.push('<Team4 />');
  return zip.file('components/Team4.jsx', content);
}
