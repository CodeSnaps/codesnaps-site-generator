...
function SidebarDraggableItem({ hasActiveSub }: { hasActiveSub: boolean }) {
  return (
    <SidebarItem
      ...
      image="https://ablcaocvmgtcodafwvoe.supabase.co/storage/v1/object/public/components/feature_7-1699971589851.webp"
      name="Feature 7"
      Component={Feature7}
    />
  );
...
function prepForPageExport(
  ...
  importStatements.push(`import Feature7 from './components/Feature7';`);
  componentContent.push('<Feature7 />');
  return zip.file('components/Feature7.jsx', content);
}
