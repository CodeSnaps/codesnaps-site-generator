...
function SidebarDraggableItem({ hasActiveSub }: { hasActiveSub: boolean }) {
  return (
    <SidebarItem
      ...
      image="https://ablcaocvmgtcodafwvoe.supabase.co/storage/v1/object/public/components/blog_8-1704323163778.webp"
      name="Blog 8"
      Component={Blog8}
    />
  );
...
function prepForPageExport(
  ...
  importStatements.push(`import Blog8 from './components/Blog8';`);
  componentContent.push('<Blog8 />');
  return zip.file('components/Blog8.jsx', content);
}
