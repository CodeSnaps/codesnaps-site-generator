...
export const Navbar5 = ({
  ...
  return (
    ...
    >
      <div
        className={clsx(
          'absolute inset-x-0 top-0 z-50 border-b p-6',
                ...
                <div key={item.name}>
                  {item.dropdown ? (
                    <Menu as="div">
                      ...
                      <Menu.Items
                        className={clsx(
                          'absolute left-0 right-0 mx-auto mt-5 max-w-[90vw] rounded-lg shadow-lg ring-1 focus:outline-none',
                      ...
                      >
                        <div className="grid w-full grid-cols-3 gap-6">
                          ...
                          <div
                            className={clsx(
                              'px-10 py-8',
                              colors[textColorKey].featuredPostsBg,
                            )}
                          >
                            <h4
                              className={clsx(
                                'mb-6 block text-base font-medium',
                                colors[textColorKey].links,
                              )}
                            >
                              {featuredBlogPostsTitle}
                            ...
                            <div className="flex flex-col gap-6">
                                    ...
                                    <div className="flex flex-col items-center gap-3 xl:flex-row xl:gap-6">
                                      ...
                                      <div className="flex flex-col gap-3">
                                        ...
                                        <Link
                                          href={post.href}
                                          className={clsx(
                                            'dark:hover:text-neutral text-sm font-medium underline',
                              ...
                              <Link
                                ...
                                className={clsx(
                                  'text-sm font-medium',
                                  colors[textColorKey].allPostsCta,
                                )}
                              >
                                {allPostsCta} &rarr;
                              </Link>
...
function SidebarDraggableItem({ hasActiveSub }: { hasActiveSub: boolean }) {
  return (
    <SidebarItem
      ...
      image="https://ablcaocvmgtcodafwvoe.supabase.co/storage/v1/object/public/components/navbar_5-1700253823539.webp"
      name="Navbar 5"
      Component={Navbar5}
    />
  );
...
function ToolbarSettings() {
  const {
    ...
    featuredBlogPostsTitle: node.data.props.featuredBlogPostsTitle,
    postCta: node.data.props.postCta,
    allPostsCta: node.data.props.allPostsCta,
...
const colors: ColorObject = {
  slate: {
    ...
    featuredPostsBg: 'bg-slate-200/50 dark:bg-slate-800',
    postCta: 'text-slate-700 dark:text-slate-200',
    allPostsCta:
      'text-slate-900 hover:text-slate-600 dark:text-slate-100 dark:hover:text-slate-300',
    primaryCta:
  ...
  gray: {
    ...
    hover: 'hover:bg-gray-200 dark:hover:bg-gray-900',
    ...
    featuredPostsBg: 'bg-gray-200/50 dark:bg-gray-800',
    postCta: 'text-gray-700 dark:text-gray-200',
    allPostsCta:
  ...
  zinc: {
    ...
    hover: 'hover:bg-zinc-200 dark:hover:bg-zinc-900',
    ...
    featuredPostsBg: 'bg-zinc-200/50 dark:bg-zinc-800',
    postCta: 'text-zinc-700 dark:text-zinc-200',
    allPostsCta:
  ...
  neutral: {
    ...
    hover: 'hover:bg-neutral-200 dark:hover:bg-neutral-900',
    ...
    featuredPostsBg: 'bg-neutral-200/50 dark:bg-neutral-800',
    postCta: 'text-neutral-700 dark:text-neutral-200',
    allPostsCta:
      'text-neutral-900 hover:text-neutral-600 dark:text-neutral-100 dark:hover:text-neutral-300',
    primaryCta:
  ...
  stone: {
    ...
    hover: 'hover:bg-stone-200 dark:hover:bg-stone-900',
    ...
    featuredPostsBg: 'bg-stone-200/50 dark:bg-stone-800',
    postCta: 'text-stone-700 dark:text-stone-200',
    allPostsCta:
      'text-stone-900 hover:text-stone-600 dark:text-stone-100 dark:hover:text-stone-300',
    primaryCta:
  ...
  red: {
    ...
    featuredPostsBg: 'bg-red-400/20 dark:bg-black/50',
    postCta: 'text-red-900 dark:text-red-100',
    allPostsCta:
      'text-red-950 hover:text-red-800 dark:text-red-50 dark:hover:text-red-200',
    primaryCta:
  ...
  orange: {
    ...
    featuredPostsBg: 'bg-orange-400/20 dark:bg-black/50',
    postCta: 'text-orange-900 dark:text-orange-100',
    allPostsCta:
      'text-orange-950 hover:text-orange-800 dark:text-orange-50 dark:hover:text-orange-200',
    primaryCta:
  ...
  amber: {
    ...
    featuredPostsBg: 'bg-amber-400/20 dark:bg-black/50',
    postCta: 'text-amber-900 dark:text-amber-100',
    allPostsCta:
      'text-amber-950 hover:text-amber-800 dark:text-amber-50 dark:hover:text-amber-200',
    primaryCta:
  ...
  yellow: {
    ...
    featuredPostsBg: 'bg-yellow-400/20 dark:bg-black/50',
    postCta: 'text-yellow-900 dark:text-yellow-100',
    allPostsCta:
      'text-yellow-950 hover:text-yellow-800 dark:text-yellow-50 dark:hover:text-yellow-200',
    primaryCta:
  ...
  lime: {
    ...
    featuredPostsBg: 'bg-lime-400/20 dark:bg-black/50',
    postCta: 'text-lime-900 dark:text-lime-100',
    allPostsCta:
      'text-lime-950 hover:text-lime-800 dark:text-lime-50 dark:hover:text-lime-200',
    primaryCta:
  ...
  green: {
    ...
    featuredPostsBg: 'bg-green-400/20 dark:bg-black/50',
    postCta: 'text-green-900 dark:text-green-100',
    allPostsCta:
      'text-green-950 hover:text-green-800 dark:text-green-50 dark:hover:text-green-200',
    primaryCta:
  ...
  emerald: {
    ...
    featuredPostsBg: 'bg-emerald-400/20 dark:bg-black/50',
    postCta: 'text-emerald-900 dark:text-emerald-100',
    allPostsCta:
      'text-emerald-950 hover:text-emerald-800 dark:text-emerald-50 dark:hover:text-emerald-200',
    primaryCta:
  ...
  teal: {
    ...
    featuredPostsBg: 'bg-teal-400/20 dark:bg-black/50',
    postCta: 'text-teal-900 dark:text-teal-100',
    allPostsCta:
      'text-teal-950 hover:text-teal-800 dark:text-teal-50 dark:hover:text-teal-200',
    primaryCta:
  ...
  cyan: {
    ...
    featuredPostsBg: 'bg-cyan-400/20 dark:bg-black/50',
    postCta: 'text-cyan-900 dark:text-cyan-100',
    allPostsCta:
      'text-cyan-950 hover:text-cyan-800 dark:text-cyan-50 dark:hover:text-cyan-200',
    primaryCta:
  ...
  sky: {
    ...
    featuredPostsBg: 'bg-sky-400/20 dark:bg-black/50',
    postCta: 'text-sky-900 dark:text-sky-100',
    allPostsCta:
      'text-sky-950 hover:text-sky-800 dark:text-sky-50 dark:hover:text-sky-200',
    primaryCta:
  ...
  blue: {
    ...
    featuredPostsBg: 'bg-blue-400/20 dark:bg-black/50',
    postCta: 'text-blue-900 dark:text-blue-100',
    allPostsCta:
      'text-blue-950 hover:text-blue-800 dark:text-blue-50 dark:hover:text-blue-200',
    primaryCta:
  ...
  indigo: {
    ...
    featuredPostsBg: 'bg-indigo-400/20 dark:bg-black/50',
    postCta: 'text-indigo-900 dark:text-indigo-100',
    allPostsCta:
      'text-indigo-950 hover:text-indigo-800 dark:text-indigo-50 dark:hover:text-indigo-200',
    primaryCta:
  ...
  violet: {
    ...
    featuredPostsBg: 'bg-violet-400/20 dark:bg-black/50',
    postCta: 'text-violet-900 dark:text-violet-100',
    allPostsCta:
      'text-violet-950 hover:text-violet-800 dark:text-violet-50 dark:hover:text-violet-200',
    primaryCta:
  ...
  purple: {
    ...
    featuredPostsBg: 'bg-purple-400/20 dark:bg-black/50',
    postCta: 'text-purple-900 dark:text-purple-100',
    allPostsCta:
      'text-purple-950 hover:text-purple-800 dark:text-purple-50 dark:hover:text-purple-200',
    primaryCta:
  ...
  fuchsia: {
    ...
    featuredPostsBg: 'bg-fuchsia-400/20 dark:bg-black/50',
    postCta: 'text-fuchsia-900 dark:text-fuchsia-100',
    allPostsCta:
      'text-fuchsia-950 hover:text-fuchsia-800 dark:text-fuchsia-50 dark:hover:text-fuchsia-200',
    primaryCta:
  ...
  pink: {
    ...
    featuredPostsBg: 'bg-pink-400/20 dark:bg-black/50',
    postCta: 'text-pink-900 dark:text-pink-100',
    allPostsCta:
      'text-pink-950 hover:text-pink-800 dark:text-pink-50 dark:hover:text-pink-200',
    primaryCta:
  ...
  rose: {
    ...
    featuredPostsBg: 'bg-rose-400/20 dark:bg-black/50',
    postCta: 'text-rose-900 dark:text-rose-100',
    allPostsCta:
      'text-rose-950 hover:text-rose-800 dark:text-rose-50 dark:hover:text-rose-200',
    primaryCta:
...
function generateComponentString({
  ...
  { name: '${removeHtmlTags(navigation[1].name)}', href: '#', dropdown: false },
  {
    ...
    group: [
      {
        name: '${removeHtmlTags(navigation[2].group[0].name)}',
        items: [
          {
            icon: GroupLinkIcon,
            name: '${removeHtmlTags(navigation[2].group[0].items[0].name)}',
            description: '${removeHtmlTags(navigation[2].group[0].items[0].description)}',
            href: '#',
          },
          {
            icon: GroupLinkIcon,
            name: '${removeHtmlTags(navigation[2].group[0].items[1].name)}',
            description: '${removeHtmlTags(navigation[2].group[0].items[1].description)}',
            href: '#',
          },
          {
            icon: GroupLinkIcon,
            name: '${removeHtmlTags(navigation[2].group[0].items[2].name)}',
            description: '${removeHtmlTags(navigation[2].group[0].items[2].description)}',
            href: '#',
          },
          {
            icon: GroupLinkIcon,
            name: '${removeHtmlTags(navigation[2].group[0].items[3].name)}',
            description: '${removeHtmlTags(navigation[2].group[0].items[3].description)}',
            href: '#',
          },
        ],
      },
      {
        name: '${removeHtmlTags(navigation[2].group[1].name)}',
        items: [
          {
            icon: GroupLinkIcon,
            name: '${removeHtmlTags(navigation[2].group[1].items[0].name)}',
            description: '${removeHtmlTags(navigation[2].group[1].items[0].description)}',
            href: '#',
          },
          {
            icon: GroupLinkIcon,
            name: '${removeHtmlTags(navigation[2].group[1].items[1].name)}',
            description: '${removeHtmlTags(navigation[2].group[1].items[1].description)}',
            href: '#',
          },
          {
            icon: GroupLinkIcon,
            name: '${removeHtmlTags(navigation[2].group[1].items[2].name)}',
            description: '${removeHtmlTags(navigation[2].group[1].items[2].description)}',
            href: '#',
          },
          {
            icon: GroupLinkIcon,
            name: '${removeHtmlTags(navigation[2].group[1].items[3].name)}',
            description: '${removeHtmlTags(navigation[2].group[1].items[3].description)}',
            href: '#',
          },
        ],
      },
    ...
    featuredPost: [
      {
        title: '${removeHtmlTags(navigation[2].featuredPost[0].title)}',
        description: '${removeHtmlTags(navigation[2].featuredPost[0].description)}',
        href: '#',
        imageSrc: 'https://dummyimage.com/1280x720/d4d4d4/171717',
        imageAlt: 'Post image',
      },
      {
        title: '${removeHtmlTags(navigation[2].featuredPost[1].title)}',
        description: '${removeHtmlTags(navigation[2].featuredPost[1].description)}',
        href: '#',
        imageSrc: 'https://dummyimage.com/1280x720/d4d4d4/171717',
        imageAlt: 'Post image',
      },
  ...
  const nextContent = `/*You need to configure remotePatterns in next.config.js to use dummyimage.com
...
export default function Navbar() {
  ...
  return (
     <header className="relative">
      <div className="absolute inset-x-0 top-0 z-50 border-b p-6 ${colors[colorKey].header}">
        <nav
          className="mx-auto flex max-w-[1600px] items-center justify-between lg:px-8"
          aria-label="Global"
        >
                ...
                <div key={item.name}>
                  {item.dropdown ? (
                    <Menu as="div">
                      ...
                      {/* DROPDOWN ITEMS */}
                      <Menu.Items className="absolute left-0 right-0 mx-auto mt-5 max-w-[90vw] rounded-lg shadow-lg ring-1 focus:outline-none ${colors[textColorKey].dropdown}">
                        <div className="grid w-full grid-cols-3 gap-6">
                          {/* COLUMS */}
                          ...
                          {/* FEATURED POSTS */}
                          <div className="px-10 py-8 ${colors[textColorKey].featuredPostsBg}">
                            <h4 className="mb-6 block text-base font-medium ${colors[textColorKey].links}">
                              ${featuredBlogPostsTitle}
                            </h4>
                            ...
                            <div className="flex flex-col gap-6">
                              {item.featuredPost.map((post) => (
                                <div key={post.title}>
                                  ...
                                  >
                                    ...
                                    <div className="flex flex-col gap-3">
                                      <h3 className="text-base font-medium ${colors[textColorKey].links}">
                                        {post.title}
                                      </h3>
                                      <p className="text-sm leading-none ${colors[textColorKey].description}">
                                        {post.description}
                                      </p>
                                      <Link
                                        href={post.href}
                                        className="text-sm font-medium underline ${colors[textColorKey].postCta}"
                                      >
                                        ${postCta}
                                      </Link>
                                    </div>
                              ...
                              <Link
                                href="#"
                                className="text-sm font-medium ${colors[textColorKey].allPostsCta}"
                              >
                                ${allPostsCta} &rarr;
                              </Link>
                            </div>
                    ...
                    <div key={item.name}>
                      {item.dropdown ? (
                        <div>
                          ...
                          {/* FEATURED POSTS */}
                          <div className="mt-10 rounded-xl p-6 ${colors[textColorKey].featuredPostsBg}">
                            <h4 className="mb-6 block text-base font-medium ${colors[textColorKey].links}">
                              ${featuredBlogPostsTitle}
                            </h4>
                                ...
                                <div key={post.title}>
                                  <div className="flex flex-col gap-2">
                                    ...
                                    <div className="flex flex-col gap-3">
                                      ...
                                      <Link
                                        href={post.href}
                                        className="dark:hover:text-neutral text-sm font-medium underline ${colors[textColorKey].postCta}"
                                      >
                                        ${postCta}
                                      </Link>
                                    </div>
                        ...
                        <Link
                          key={item.name}
                          href={item.href}
                          className="-mx-3 block rounded-lg px-3 py-2 text-base font-semibold leading-7 ${colors[textColorKey].links} ${colors[colorKey].hover}"
                        >
                          {item.name}
                        </Link>
                      )}
...
function prepForPageExport(
  ...
  importStatements.push(`import Navbar5 from './components/Navbar5';`);
  componentContent.push('<Navbar5 />');
  return zip.file('components/Navbar5.jsx', content);
}

Navbar5.craft = {
  props: {
    navigation: navigation,
    featuredBlogPostsTitle: 'Featured Posts from the Blog',
    postCta: 'Read more',
