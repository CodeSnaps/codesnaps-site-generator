      ...
      <div className="block items-end justify-between lg:flex">
        ...
        <div className="mt-6 flex justify-center">
          <ContentEditable
            ...
            disabled={query.getOptions().enabled ? false : true}
            className={clsx(
              'rounded-md px-10 py-3 text-base font-medium shadow-sm ring-1 ring-inset',
              'outline-none focus:outline-offset-4 focus:outline-primary',
              colors[colorKey].cta,
            )}
          />
                  ...
                  <div className="mt-6 flex items-center">
                    ...
                    >
                      <ContentEditable
                        html={postCta}
                        onChange={(e) =>
                          setProp((props: { postCta: string }) => {
                            props.postCta = e.target.value;
                          })
                        }
                        tagName="span"
                        disabled={query.getOptions().enabled ? false : true}
...
function SidebarDraggableItem({ hasActiveSub }: { hasActiveSub: boolean }) {
  return (
    <SidebarItem
      ...
      image="https://ablcaocvmgtcodafwvoe.supabase.co/storage/v1/object/public/components/blog_2-1699470183514.webp"
      name="Blog 2"
      Component={Blog2}
    />
  );
...
const colors: ColorObject = {
  ...
  red: {
    ...
    cta: 'bg-white dark:bg-black text-red-900 ring-red-500 focus-visible:outline-red-500 dark:focus-visible:outline-red-400 hover:bg-red-100 dark:text-red-100 dark:ring-red-800 dark:hover:bg-red-900/30',
  ...
  orange: {
    ...
    cta: 'bg-white dark:bg-black text-orange-900 ring-orange-500 focus-visible:outline-orange-500 dark:focus-visible:outline-orange-400 hover:bg-orange-100 dark:text-orange-100 dark:ring-orange-800 dark:hover:bg-orange-900/30',
  ...
  amber: {
    ...
    cta: 'bg-white dark:bg-black text-amber-900 ring-amber-500 focus-visible:outline-amber-500 dark:focus-visible:outline-amber-400 hover:bg-amber-100 dark:text-amber-100 dark:ring-amber-800 dark:hover:bg-amber-900/30',
  ...
  yellow: {
    ...
    cta: 'bg-white dark:bg-black text-yellow-900 ring-yellow-500 focus-visible:outline-yellow-500 dark:focus-visible:outline-yellow-400 hover:bg-yellow-100 dark:text-yellow-100 dark:ring-yellow-800 dark:hover:bg-yellow-900/30',
  ...
  lime: {
    ...
    cta: 'bg-white dark:bg-black text-lime-900 ring-lime-500 focus-visible:outline-lime-500 dark:focus-visible:outline-lime-400 hover:bg-lime-100 dark:text-lime-100 dark:ring-lime-800 dark:hover:bg-lime-900/30',
  ...
  green: {
    ...
    cta: 'bg-white dark:bg-black text-green-900 ring-green-500 focus-visible:outline-green-500 dark:focus-visible:outline-green-400 hover:bg-green-100 dark:text-green-100 dark:ring-green-800 dark:hover:bg-green-900/30',
  ...
  emerald: {
    ...
    cta: 'bg-white dark:bg-black text-emerald-900 ring-emerald-500 focus-visible:outline-emerald-500 dark:focus-visible:outline-emerald-400 hover:bg-emerald-100 dark:text-emerald-100 dark:ring-emerald-800 dark:hover:bg-emerald-900/30',
  ...
  teal: {
    ...
    cta: 'bg-white dark:bg-black text-teal-900 ring-teal-500 focus-visible:outline-teal-500 dark:focus-visible:outline-teal-400 hover:bg-teal-100 dark:text-teal-100 dark:ring-teal-800 dark:hover:bg-teal-900/30',
  ...
  cyan: {
    ...
    cta: 'bg-white dark:bg-black text-cyan-900 ring-cyan-500 focus-visible:outline-cyan-500 dark:focus-visible:outline-cyan-400 hover:bg-cyan-100 dark:text-cyan-100 dark:ring-cyan-800 dark:hover:bg-cyan-900/30',
  ...
  sky: {
    ...
    cta: 'bg-white dark:bg-black text-sky-900 ring-sky-500 focus-visible:outline-sky-500 dark:focus-visible:outline-sky-400 hover:bg-sky-100 dark:text-sky-100 dark:ring-sky-800 dark:hover:bg-sky-900/30',
  ...
  blue: {
    ...
    cta: 'bg-white dark:bg-black text-blue-900 ring-blue-500 focus-visible:outline-blue-500 dark:focus-visible:outline-blue-400 hover:bg-blue-100 dark:text-blue-100 dark:ring-blue-800 dark:hover:bg-blue-900/30',
  ...
  indigo: {
    ...
    postCta: 'text-indigo-600 dark:text-indigo-200',
    postMetadata: 'text-indigo-600 dark:text-indigo-400',
    cta: 'bg-white dark:bg-black text-indigo-900 ring-indigo-500 focus-visible:outline-indigo-500 dark:focus-visible:outline-indigo-400 hover:bg-indigo-100 dark:text-indigo-100 dark:ring-indigo-800 dark:hover:bg-indigo-900/30',
  ...
  violet: {
    ...
    cta: 'bg-white dark:bg-black text-violet-900 ring-violet-500 focus-visible:outline-violet-500 dark:focus-visible:outline-violet-400 hover:bg-violet-100 dark:text-violet-100 dark:ring-violet-800 dark:hover:bg-violet-900/30',
  ...
  purple: {
    ...
    cta: 'bg-white dark:bg-black text-purple-900 ring-purple-500 focus-visible:outline-purple-500 dark:focus-visible:outline-purple-400 hover:bg-purple-100 dark:text-purple-100 dark:ring-purple-800 dark:hover:bg-purple-900/30',
  ...
  fuchsia: {
    ...
    cta: 'bg-white dark:bg-black text-fuchsia-900 ring-fuchsia-500 focus-visible:outline-fuchsia-500 dark:focus-visible:outline-fuchsia-400 hover:bg-fuchsia-100 dark:text-fuchsia-100 dark:ring-fuchsia-800 dark:hover:bg-fuchsia-900/30',
  ...
  pink: {
    ...
    cta: 'bg-white dark:bg-black text-pink-900 ring-pink-500 focus-visible:outline-pink-500 dark:focus-visible:outline-pink-400 hover:bg-pink-100 dark:text-pink-100 dark:ring-pink-800 dark:hover:bg-pink-900/30',
  ...
  rose: {
    ...
    cta: 'bg-white dark:bg-black text-rose-900 ring-rose-500 focus-visible:outline-rose-500 dark:focus-visible:outline-rose-400 hover:bg-rose-100 dark:text-rose-100 dark:ring-rose-800 dark:hover:bg-rose-900/30',
    ...
    <div className="${clsx(
      ...
      <div className="block items-end justify-between lg:flex">
        ...
        <div className="mt-6 flex justify-center">
          <Link
            href="#"
            className="rounded-md px-10 py-3 text-base font-medium shadow-sm ring-1 ring-inset ${colors[textColorKey].cta}"
          >
            ${removeHtmlTags(cta)}
          </Link>
        </div>
      ...
      <div className="mx-auto mt-10 max-w-md sm:mt-14 md:max-w-2xl lg:mt-20 lg:max-w-none">
        <dl className="grid grid-cols-1 gap-x-8 gap-y-16 md:grid-cols-2 xl:grid-cols-3">
          {posts.map((post) => (
            <div
              key={post.id}
              className="flex flex-col rounded-md border shadow-sm ${colors[colorKey].border}"
            >
              <Image
                priority
                src={post.imgSrc}
              ...
              <div className="px-3 py-8 lg:px-4 lg:py-10">
                <div className="flex items-center space-x-4">
                  <span className="rounded-sm p-2 text-xs font-medium uppercase ${colors[textColorKey].postCategory}">
                    {post.category}
                  </span>
                  <time
                    dateTime={post.metadata.datetime}
...
function prepForPageExport(
  ...
  importStatements.push(`import Blog2 from './components/Blog2';`);
  componentContent.push('<Blog2 />');
  return zip.file('components/Blog2.jsx', content);
}
