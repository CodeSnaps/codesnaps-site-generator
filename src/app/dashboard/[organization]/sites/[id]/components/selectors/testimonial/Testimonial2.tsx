...
const colors: ColorObject = {
  slate: {
    ...
    testimonial: 'text-slate-700 dark:text-slate-300',
    name: 'text-slate-800 dark:text-slate-300',
  ...
  gray: {
    ...
    testimonial: 'text-gray-700 dark:text-gray-300',
    name: 'text-gray-800 dark:text-gray-300',
  ...
  zinc: {
    ...
    testimonial: 'text-zinc-700 dark:text-zinc-300',
    name: 'text-zinc-800 dark:text-zinc-300',
  ...
  neutral: {
    ...
    testimonial: 'text-neutral-700 dark:text-neutral-300',
    name: 'text-neutral-800 dark:text-neutral-300',
  ...
  stone: {
    ...
    testimonial: 'text-stone-700 dark:text-stone-300',
    name: 'text-stone-800 dark:text-stone-300',
  ...
  red: {
    ...
    testimonial: 'text-red-700 dark:text-red-100/70',
    name: 'text-red-900 dark:text-red-400/70',
  ...
  orange: {
    ...
    testimonial: 'text-orange-700 dark:text-orange-100/70',
    name: 'text-orange-900 dark:text-orange-400/70',
  ...
  amber: {
    ...
    testimonial: 'text-amber-700 dark:text-amber-100/70',
    name: 'text-amber-900 dark:text-amber-400/70',
  ...
  yellow: {
    ...
    testimonial: 'text-yellow-700 dark:text-yellow-100/70',
    name: 'text-yellow-900 dark:text-yellow-400/70',
  ...
  lime: {
    ...
    testimonial: 'text-lime-700 dark:text-lime-100/70',
    name: 'text-lime-900 dark:text-lime-400/70',
  ...
  green: {
    ...
    testimonial: 'text-green-700 dark:text-green-100/70',
    name: 'text-green-900 dark:text-green-400/70',
  ...
  emerald: {
    ...
    testimonial: 'text-emerald-700 dark:text-emerald-100/70',
    name: 'text-emerald-900 dark:text-emerald-400/70',
  ...
  teal: {
    ...
    testimonial: 'text-teal-700 dark:text-teal-100/70',
    name: 'text-teal-900 dark:text-teal-400/70',
  ...
  cyan: {
    ...
    testimonial: 'text-cyan-700 dark:text-cyan-100/70',
    name: 'text-cyan-900 dark:text-cyan-400/70',
  ...
  sky: {
    ...
    testimonial: 'text-sky-700 dark:text-sky-100/70',
    name: 'text-sky-900 dark:text-sky-400/70',
  ...
  blue: {
    ...
    testimonial: 'text-blue-700 dark:text-blue-100/70',
    name: 'text-blue-900 dark:text-blue-400/70',
  ...
  indigo: {
    ...
    testimonial: 'text-indigo-700 dark:text-indigo-100/70',
    name: 'text-indigo-900 dark:text-indigo-400/70',
  ...
  violet: {
    ...
    testimonial: 'text-violet-700 dark:text-violet-100/70',
    name: 'text-violet-900 dark:text-violet-400/70',
  ...
  purple: {
    ...
    testimonial: 'text-purple-700 dark:text-purple-100/70',
    name: 'text-purple-900 dark:text-purple-400/70',
  ...
  fuchsia: {
    ...
    testimonial: 'text-fuchsia-700 dark:text-fuchsia-100/70',
    name: 'text-fuchsia-900 dark:text-fuchsia-400/70',
  ...
  pink: {
    ...
    testimonial: 'text-pink-700 dark:text-pink-100/70',
    name: 'text-pink-900 dark:text-pink-400/70',
  ...
  rose: {
    ...
    testimonial: 'text-rose-700 dark:text-rose-100/70',
    name: 'text-rose-900 dark:text-rose-400/70',
