      ...
      <div className="grid gap-7 xl:grid-cols-2">
        <div className="flex flex-col gap-4">
          ...
          <ContentEditable
            ...
            disabled={query.getOptions().enabled ? false : true}
            className={clsx(
              'text-3xl font-bold leading-tight tracking-wide xl:text-5xl',
              'outline-none focus:outline-offset-4 focus:outline-primary',
...
function SidebarDraggableItem({ hasActiveSub }: { hasActiveSub: boolean }) {
  return (
    <SidebarItem
      ...
      image="https://ablcaocvmgtcodafwvoe.supabase.co/storage/v1/object/public/components/feature_17-1699974131716.webp"
      name="Feature 17"
      Component={Feature17}
    />
  );
...
export default function Feature() {
  return (
    ...
    <div className="grid gap-7 xl:grid-cols-2">
        ...
        <div className="flex flex-col gap-4">
          <p className="max-w-4xl text-lg ${colors[textColorKey].description}">
          ...
          <div className="flex space-x-4">
            ...
            <Link
              href="#"
                className="rounded-md px-10 py-3 text-sm font-semibold shadow-sm ring-1 ring-inset focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 ${colors[colorKey].primaryCta}"
            >
...
function prepForPageExport(
  ...
  importStatements.push(`import Feature17 from './components/Feature17';`);
  componentContent.push('<Feature17 />');
  return zip.file('components/Feature17.jsx', content);
}
...
Feature17.craft = {
  props: {
    ...
    description:
      'Rhoncus morbi et augue nec, in id ullamcorper at sit. Condimentum sit nunc in eros scelerisque sed. Commodo in viverra nunc, ullamcorper ut. Non, amet, aliquet scelerisque nullam.',
