                    ...
                    <div className="flex items-center">
                      ...
                      <div>
                        <ContentEditable
                          ...
                          onChange={(e) =>
                            setProp((props: any) => {
                              props.posts[index].metadata.author =
                                e.target.value;
                            })
                          }
                          tagName="h4"
                        ...
                        >
                          <ContentEditable
                            ...
                            onChange={(e) =>
                              setProp((props: any) => {
                                props.posts[index].metadata.date =
                                  e.target.value;
                              })
                            }
                            tagName="time"
...
function SidebarDraggableItem({ hasActiveSub }: { hasActiveSub: boolean }) {
  return (
    <SidebarItem
      ...
      image="https://ablcaocvmgtcodafwvoe.supabase.co/storage/v1/object/public/components/blog_5-1699792121565.webp"
      name="Blog 5"
      Component={Blog5}
    />
  );
...
function prepForPageExport(
  ...
  importStatements.push(`import Blog5 from './components/Blog5';`);
  componentContent.push('<Blog5 />');
  return zip.file('components/Blog5.jsx', content);
}
