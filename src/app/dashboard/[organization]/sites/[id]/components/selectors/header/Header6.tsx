    ...
    >
      ...
      >
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-6xl py-24 text-center lg:py-32">
            <ContentEditable
              html={heading}
              onChange={(e) =>
                setProp(
...
function SidebarDraggableItem({ hasActiveSub }: { hasActiveSub: boolean }) {
  return (
    <SidebarItem
      ...
      image="https://ablcaocvmgtcodafwvoe.supabase.co/storage/v1/object/public/components/header_6-1700071316954.webp"
      name="Header 6"
      Component={Header6}
    />
  );
      ...
      />
       ...
       <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-6xl py-24 text-center lg:py-32">
          ...
          <p className="mx-auto mt-6 max-w-md text-lg ${colors[textColorKey].description}">
...
function prepForPageExport(
  ...
  importStatements.push(`import Header6 from './components/Header6';`);
  componentContent.push('<Header6 />');
  return zip.file('components/Header6.jsx', content);
}
