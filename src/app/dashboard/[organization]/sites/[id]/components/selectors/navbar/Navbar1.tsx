...
function SidebarDraggableItem({ hasActiveSub }: { hasActiveSub: boolean }) {
  return (
    <SidebarItem
      ...
      image="https://ablcaocvmgtcodafwvoe.supabase.co/storage/v1/object/public/components/navbar_1-1700253191223.webp"
      name="Navbar 1"
      Component={Navbar1}
    />
  );
...
function prepForPageExport(
  ...
  importStatements.push(`import Navbar1 from './components/Navbar1';`);
  componentContent.push('<Navbar1 />');
  return zip.file('components/Navbar1.jsx', content);
}
