...
function SidebarDraggableItem({ hasActiveSub }: { hasActiveSub: boolean }) {
  return (
    <SidebarItem
      ...
      image="https://ablcaocvmgtcodafwvoe.supabase.co/storage/v1/object/public/components/header_1-1699474507204.webp"
      name="Header 1"
      Component={Header1}
    />
  );
...
function prepForPageExport(
  ...
  importStatements.push(`import Header1 from './components/Header1';`);
  componentContent.push('<Header1 />');
  return zip.file('components/Header1.jsx', content);
}
