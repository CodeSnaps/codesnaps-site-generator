            ...
            <SwiperSlide key={member.id} className="max-w-md pb-20">
              <div className="flex flex-col space-y-4">
                ...
                <ContentEditable
                  ...
                  onChange={(e) =>
                    setProp((props: any) => {
                      props.team[member.id - 1].description = e.target.value;
                    })
                  }
                  tagName="p"
                  disabled={query.getOptions().enabled ? false : true}
...
function SidebarDraggableItem({ hasActiveSub }: { hasActiveSub: boolean }) {
  return (
    <SidebarItem
      ...
      image="https://ablcaocvmgtcodafwvoe.supabase.co/storage/v1/object/public/components/team_5-1700175108148.webp"
      name="Team 5"
      Component={Team5}
    />
  );
...
const colors: ColorObject = {
  slate: {
    ...
    cta: 'bg-slate-50 text-slate-900 ring-slate-300 hover:bg-slate-50 dark:bg-slate-900 dark:text-white dark:ring-slate-800 dark:hover:bg-slate-800',
  },
  gray: {
    ...
    cta: 'bg-gray-50 text-gray-900 ring-gray-300 hover:bg-gray-50 dark:bg-gray-900 dark:text-white dark:ring-gray-800 dark:hover:bg-gray-800',
  },
  zinc: {
    ...
    cta: 'bg-zinc-50 text-zinc-900 ring-zinc-300 hover:bg-zinc-50 dark:bg-zinc-900 dark:text-white dark:ring-zinc-800 dark:hover:bg-zinc-800',
  },
  neutral: {
    ...
    cta: 'bg-neutral-50 text-neutral-900 ring-neutral-300 hover:bg-neutral-50 dark:bg-neutral-900 dark:text-white dark:ring-neutral-800 dark:hover:bg-neutral-800',
  },
  stone: {
    ...
    cta: 'bg-stone-50 text-stone-900 ring-stone-300 hover:bg-stone-50 dark:bg-stone-900 dark:text-white dark:ring-stone-800 dark:hover:bg-stone-800',
  },
  red: {
    ...
    cta: 'bg-red-50 text-red-900 ring-red-300 hover:bg-red-100/70 dark:bg-red-950 dark:text-white dark:ring-red-900 dark:hover:bg-red-900',
  },
  orange: {
    ...
    cta: 'bg-orange-50 text-orange-900 ring-orange-300 hover:bg-orange-100/70 dark:bg-orange-950 dark:text-white dark:ring-orange-900 dark:hover:bg-orange-900',
  },
  amber: {
    ...
    cta: 'bg-amber-50 text-amber-900 ring-amber-300 hover:bg-amber-100/70 dark:bg-amber-950 dark:text-white dark:ring-amber-900 dark:hover:bg-amber-900',
  },
  yellow: {
    ...
    cta: 'bg-yellow-50 text-yellow-900 ring-yellow-300 hover:bg-yellow-100/70 dark:bg-yellow-950 dark:text-white dark:ring-yellow-900 dark:hover:bg-yellow-900',
  },
  lime: {
    ...
    cta: 'bg-lime-50 text-lime-900 ring-lime-300 hover:bg-lime-100/70 dark:bg-lime-950 dark:text-white dark:ring-lime-900 dark:hover:bg-lime-900',
  },
  green: {
    ...
    cta: 'bg-green-50 text-green-900 ring-green-300 hover:bg-green-100/70 dark:bg-green-950 dark:text-white dark:ring-green-900 dark:hover:bg-green-900',
  },
  emerald: {
    ...
    cta: 'bg-emerald-50 text-emerald-900 ring-emerald-300 hover:bg-emerald-100/70 dark:bg-emerald-950 dark:text-white dark:ring-emerald-900 dark:hover:bg-emerald-900',
  },
  teal: {
    ...
    cta: 'bg-teal-50 text-teal-900 ring-teal-300 hover:bg-teal-100/70 dark:bg-teal-950 dark:text-white dark:ring-teal-900 dark:hover:bg-teal-900',
  },
  cyan: {
    ...
    cta: 'bg-cyan-50 text-cyan-900 ring-cyan-300 hover:bg-cyan-100/70 dark:bg-cyan-950 dark:text-white dark:ring-cyan-900 dark:hover:bg-cyan-900',
  },
  sky: {
    ...
    cta: 'bg-sky-50 text-sky-900 ring-sky-300 hover:bg-sky-100/70 dark:bg-sky-950 dark:text-white dark:ring-sky-900 dark:hover:bg-sky-900',
  },
  blue: {
    ...
    cta: 'bg-blue-50 text-blue-900 ring-blue-300 hover:bg-blue-100/70 dark:bg-blue-950 dark:text-white dark:ring-blue-900 dark:hover:bg-blue-900',
  },
  indigo: {
    ...
    cta: 'bg-indigo-50 text-indigo-900 ring-indigo-300 hover:bg-indigo-100/70 dark:bg-indigo-950 dark:text-white dark:ring-indigo-900 dark:hover:bg-indigo-900',
  },
  violet: {
    ...
    cta: 'bg-violet-50 text-violet-900 ring-violet-300 hover:bg-violet-100/70 dark:bg-violet-950 dark:text-white dark:ring-violet-900 dark:hover:bg-violet-900',
  },
  purple: {
    ...
    cta: 'bg-purple-50 text-purple-900 ring-purple-300 hover:bg-purple-100/70 dark:bg-purple-950 dark:text-white dark:ring-purple-900 dark:hover:bg-purple-900',
  },
  fuchsia: {
    ...
    cta: 'bg-fuchsia-50 text-fuchsia-900 ring-fuchsia-300 hover:bg-fuchsia-100/70 dark:bg-fuchsia-950 dark:text-white dark:ring-fuchsia-900 dark:hover:bg-fuchsia-900',
  },
  pink: {
    ...
    cta: 'bg-pink-50 text-pink-900 ring-pink-300 hover:bg-pink-100/70 dark:bg-pink-950 dark:text-white dark:ring-pink-900 dark:hover:bg-pink-900',
  },
  rose: {
    ...
    cta: 'bg-rose-50 text-rose-900 ring-rose-300 hover:bg-rose-100/70 dark:bg-rose-950 dark:text-white dark:ring-rose-900 dark:hover:bg-rose-900',
  },
};
...
function prepForPageExport(
  ...
  importStatements.push(`import Team5 from './components/Team5';`);
  componentContent.push('<Team5 />');
  return zip.file('components/Team5.jsx', content);
}
