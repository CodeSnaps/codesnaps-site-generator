...
export const Footer1 = ({
  ...
  newsletterSignUpFormHeading?: string;
      ...
      >
        <div className="xl:grid xl:grid-cols-2 xl:gap-8">
          <div className="space-y-8">
            ...
            <ContentEditable
              html={newsletterSignUpFormHeading}
              onChange={(e) =>
                setProp(
                  (props: { newsletterSignUpFormHeading: string }) =>
                    (props.newsletterSignUpFormHeading = e.target.value),
                )
              }
              tagName="p"
            ...
            <div className="mt-10 md:mt-0">
              ...
              <ul role="list" className="mt-6 space-y-4">
                <li>
                  ...
                  >
                    <span className="sr-only">{navigationSocial[0].name}</span>
                    <FacebookLogo className="h-6 w-6" aria-hidden="true" />
                    <ContentEditable
                      html={navigationSocial[0].name}
                      onChange={(e) =>
                        setProp((props: any) => {
                          props.navigationSocial[0].name = e.target.value;
                        })
                      }
                      tagName="span"
                      disabled={query.getOptions().enabled ? false : true}
                ...
                <li>
                  ...
                  >
                    <span className="sr-only">{navigationSocial[1].name}</span>
                    <InstagramLogo className="h-6 w-6" aria-hidden="true" />
                    <ContentEditable
                      html={navigationSocial[1].name}
                      onChange={(e) =>
                        setProp((props: any) => {
                          props.navigationSocial[1].name = e.target.value;
                        })
                      }
                      tagName="span"
                      disabled={query.getOptions().enabled ? false : true}
                ...
                <li>
                  ...
                  >
                    <span className="sr-only">{navigationSocial[2].name}</span>
                    <XLogo className="h-6 w-6" aria-hidden="true" />
                    <ContentEditable
                      html={navigationSocial[2].name}
                      onChange={(e) =>
                        setProp((props: any) => {
                          props.navigationSocial[2].name = e.target.value;
                        })
                      }
                      tagName="span"
                      disabled={query.getOptions().enabled ? false : true}
                ...
                <li>
                  ...
                  >
                    <span className="sr-only">{navigationSocial[3].name}</span>
                    <LinkedInLogo className="h-6 w-6" aria-hidden="true" />
                    <ContentEditable
                      html={navigationSocial[3].name}
                      onChange={(e) =>
                        setProp((props: any) => {
                          props.navigationSocial[3].name = e.target.value;
                        })
                      }
                      tagName="span"
                      disabled={query.getOptions().enabled ? false : true}
                ...
                <li>
                  ...
                  >
                    <span className="sr-only">{navigationSocial[4].name}</span>
                    <YouTubeLogo className="h-6 w-6" aria-hidden="true" />
                    <ContentEditable
                      html={navigationSocial[4].name}
                      onChange={(e) =>
                        setProp((props: any) => {
                          props.navigationSocial[4].name = e.target.value;
                        })
                      }
                      tagName="span"
                      disabled={query.getOptions().enabled ? false : true}
...
function SidebarDraggableItem({ hasActiveSub }: { hasActiveSub: boolean }) {
  return (
    <SidebarItem
      ...
      image="https://ablcaocvmgtcodafwvoe.supabase.co/storage/v1/object/public/components/footer_1-1699473725055.webp"
      name="Footer 1"
      Component={Footer1}
    />
  );
...
function ToolbarSettings() {
  const {
    ...
    newsletterSignUpFormHeading: node.data.props.newsletterSignUpFormHeading,
    ...
    navigationSocial: node.data.props.navigationSocial,
...
function generateComponentString({
  ...
  social: [
    {
      name: '${removeHtmlTags(navigationSocial[0].name)}',
      href: '#',
      icon: (props) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          <path
    ...
    {
      name: '${removeHtmlTags(navigationSocial[1].name)}',
      href: '#',
      icon: (props) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          <path
    ...
    {
      name: '${removeHtmlTags(navigationSocial[2].name)}',
      href: '#',
      icon: (props) => (
        <svg fill="currentColor" viewBox="0 0 300 271" {...props}>
          <path d="M236 0h46L181 115l118 156h-92.6l-72.5-94.8-83 94.8h-46l107-123L-1.1 0h94.9l65.5 86.6L236 0zm-16.1 244h25.5L80.4 26H53l166.9 218z"></path>
    ...
    {
      name: '${removeHtmlTags(navigationSocial[3].name)}',
      href: '#',
      icon: (props) => (
        <svg viewBox="0 0 24 24" fill="currentColor" {...props}>
          <path
    ...
    {
      name: '${removeHtmlTags(navigationSocial[4].name)}',
      href: '#',
      icon: (props) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          <path
  ...
  return (
    <footer aria-labelledby="footer-heading">
      ...
      <div className="${clsx(
        ...
        <div className="xl:grid xl:grid-cols-2 xl:gap-8">
          <div className="space-y-8">
            <Logo
              ...
              alt="Company name"
            />
            <p className="text-sm leading-6 ${colors[textColorKey].newsletterHeading}">
              ${removeHtmlTags(newsletterSignUpFormHeading)}
            </p>
            ...
            <div className="flex flex-col space-y-4">
              ...
              <span className="block max-w-md text-sm ${colors[textColorKey].disclaimer}">
                ...
                {navigation.social.map((item) => (
                  <li key={item.name}>
                    <Link
                      key={item.name}
                      href={item.href}
                      className="group flex items-center ${colors[textColorKey].links}"
                    >
                      <span className="sr-only">{item.name}</span>
                      <item.icon className="h-6 w-6" aria-hidden="true" />
                      <span className="ml-3 text-sm leading-6 ${colors[textColorKey].iconLabel}">
                        {item.name}
                      </span>
                    </Link>
                  </li>
        ...
        <div className="mt-16 flex flex-col justify-between space-y-6 border-t pt-8 sm:mt-20 md:flex-row md:items-end lg:mt-24 ${colors[textColorKey].border}">
...
function prepForPageExport(
  ...
  importStatements.push(`import Footer1 from './components/Footer1';`);
  componentContent.push('<Footer1 />');
  return zip.file('components/Footer1.jsx', content);
}
