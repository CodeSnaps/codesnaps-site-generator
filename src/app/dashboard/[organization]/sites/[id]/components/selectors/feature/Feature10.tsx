...
function SidebarDraggableItem({ hasActiveSub }: { hasActiveSub: boolean }) {
  return (
    <SidebarItem
      ...
      image="https://ablcaocvmgtcodafwvoe.supabase.co/storage/v1/object/public/components/feature_10-1699972896258.webp"
      name="Feature 10"
      Component={Feature10}
    />
  );
...
function prepForPageExport(
  ...
  importStatements.push(`import Feature10 from './components/Feature10';`);
  componentContent.push('<Feature10 />');
  return zip.file('components/Feature10.jsx', content);
}
