...
function SidebarDraggableItem({ hasActiveSub }: { hasActiveSub: boolean }) {
  return (
    <SidebarItem
      ...
      image="https://ablcaocvmgtcodafwvoe.supabase.co/storage/v1/object/public/components/hero_8-1700433056252.webp"
      name="Hero 8"
      Component={Hero8}
    />
  );
...
function prepForPageExport(
  ...
  importStatements.push(`import Hero8 from './components/Hero8';`);
  componentContent.push('<Hero8 />');
  return zip.file('components/Hero8.jsx', content);
}
