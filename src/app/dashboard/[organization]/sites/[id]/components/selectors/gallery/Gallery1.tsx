...
function SidebarDraggableItem({ hasActiveSub }: { hasActiveSub: boolean }) {
  return (
    <SidebarItem
      ...
      image="https://ablcaocvmgtcodafwvoe.supabase.co/storage/v1/object/public/components/gallery_1-1699474133472.webp"
      name="Gallery 1"
      Component={Gallery1}
    />
  );
...
function prepForPageExport(
  ...
  importStatements.push(`import Gallery1 from './components/Gallery1';`);
  componentContent.push('<Gallery1 />');
  return zip.file('components/Gallery1.jsx', content);
}
