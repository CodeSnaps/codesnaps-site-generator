...
export const FAQ1 = ({
  ...
  secondDescription = '',
  cta = '',
  paddingArray = ['px-6', 'pt-24', 'sm:pt-32', 'lg:px-8', 'lg:pt-40'],
  marginArray = ['mx-auto'],
  maxWidth = 'max-w-7xl',
  color = 'neutral',
  textColor = 'neutral',
  ...
  return (
    ...
    >
      <div>
        <div
          className={clsx(
            'mx-auto max-w-4xl divide-y',
            colors[colorKey].divider,
          )}
        >
      ...
      <div className="mt-16 px-6 text-center sm:mt-24 lg:px-8">
        <ContentEditable
          html={secondHeading}
          onChange={(e) =>
            setProp((props: { secondHeading: string }) => {
        ...
        <ContentEditable
          ...
          onChange={(e) =>
            setProp((props: { secondDescription: string }) => {
          ...
          disabled={query.getOptions().enabled ? false : true}
          className={clsx(
            'mx-auto mt-6 max-w-2xl text-base md:text-lg',
            'outline-none focus:outline-offset-4 focus:outline-primary',
            colors[textColorKey].description,
          )}
        />
...
function SidebarDraggableItem({ hasActiveSub }: { hasActiveSub: boolean }) {
  return (
    <SidebarItem
      ...
      image="https://ablcaocvmgtcodafwvoe.supabase.co/storage/v1/object/public/components/faq_1-1699473259987.webp"
      name="FAQ 1"
      Component={FAQ1}
    />
  );
...
const colors: ColorObject = {
  slate: {
    divider: 'divide-slate-900/10 dark:divide-white/30',
  ...
  gray: {
    divider: 'divide-gray-900/10 dark:divide-white/30',
  ...
  zinc: {
    divider: 'divide-zinc-900/10 dark:divide-white/30',
  ...
  neutral: {
    divider: 'divide-neutral-900/10 dark:divide-white/30',
  ...
  stone: {
    divider: 'divide-stone-900/10 dark:divide-white/30',
  ...
  red: {
    divider: 'divide-red-800/10 dark:divide-white/30',
  ...
  orange: {
    divider: 'divide-orange-800/10 dark:divide-white/30',
  ...
  amber: {
    divider: 'divide-amber-800/10 dark:divide-white/30',
  ...
  yellow: {
    divider: 'divide-yellow-800/10 dark:divide-white/30',
  ...
  lime: {
    divider: 'divide-lime-800/10 dark:divide-white/30',
  ...
  green: {
    divider: 'divide-green-800/10 dark:divide-white/30',
  ...
  emerald: {
    divider: 'divide-emerald-800/10 dark:divide-white/30',
  ...
  teal: {
    divider: 'divide-teal-800/10 dark:divide-white/30',
  ...
  cyan: {
    divider: 'divide-cyan-800/10 dark:divide-white/30',
  ...
  sky: {
    divider: 'divide-sky-800/10 dark:divide-white/30',
  ...
  blue: {
    divider: 'divide-blue-800/10 dark:divide-white/30',
  ...
  indigo: {
    divider: 'divide-indigo-800/10 dark:divide-white/30',
  ...
  violet: {
    divider: 'divide-violet-800/10 dark:divide-white/30',
  ...
  purple: {
    divider: 'divide-purple-800/10 dark:divide-white/30',
  ...
  fuchsia: {
    divider: 'divide-fuchsia-800/10 dark:divide-white/30',
  ...
  pink: {
    divider: 'divide-pink-800/10 dark:divide-white/30',
  ...
  rose: {
    divider: 'divide-rose-800/10 dark:divide-white/30',
  ...
  return (
    <div>
       <div className="${clsx(
        ...
        <div className="mx-auto max-w-4xl divide-y ${colors[colorKey].divider}">
          <div className="text-center">
          ...
          <dl className="mt-24 space-y-6 divide-y ${colors[colorKey].divider}">
            {faqs.map((faq) => (
              <Disclosure as="div" key={faq.id} className="pt-6">
                {({ open }) => (
                  <>
      ...
      <div className="mt-16 px-6 text-center sm:mt-24 lg:px-8">
        ...
        <p className="mx-auto mt-6 max-w-2xl text-base md:text-lg ${colors[textColorKey].description}">
...
function prepForPageExport(
  ...
  importStatements.push(`import FAQ1 from './components/FAQ1';`);
  componentContent.push('<FAQ1 />');
  return zip.file('components/FAQ1.jsx', content);
}
