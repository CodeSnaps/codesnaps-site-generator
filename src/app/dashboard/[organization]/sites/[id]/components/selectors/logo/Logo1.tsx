...
function SidebarDraggableItem({ hasActiveSub }: { hasActiveSub: boolean }) {
  return (
    <SidebarItem
      ...
      image="https://ablcaocvmgtcodafwvoe.supabase.co/storage/v1/object/public/components/logo_1-1699474825204.webp"
      name="Logo 1"
      Component={Logo1}
    />
  );
...
function prepForPageExport(
  ...
  importStatements.push(`import Logo1 from './components/Logo1';`);
  componentContent.push('<Logo1 />');
  return zip.file('components/Logo1.jsx', content);
}
