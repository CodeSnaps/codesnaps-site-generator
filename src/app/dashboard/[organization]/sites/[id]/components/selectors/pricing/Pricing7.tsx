...
function SidebarDraggableItem({ hasActiveSub }: { hasActiveSub: boolean }) {
  return (
    <SidebarItem
      ...
      image="https://ablcaocvmgtcodafwvoe.supabase.co/storage/v1/object/public/components/pricing_7-1699801200776.webp"
      name="Pricing 7"
      Component={Pricing7}
    />
  );
...
function prepForPageExport(
  ...
  importStatements.push(`import Pricing7 from './components/Pricing7';`);
  componentContent.push('<Pricing7 />');
  return zip.file('components/Pricing7.jsx', content);
}
