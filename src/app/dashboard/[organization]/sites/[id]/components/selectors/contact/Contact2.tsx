          ...
          <form action="#" method="POST">
              ...
              <div className="sm:col-span-2">
                ...
                <div className="mt-2.5">
                  <input
                    ...
                    autoComplete="name"
                    className={clsx(
                      'block w-full rounded-md border-0 px-3.5 py-2 ring-1 ring-inset focus:ring-2 focus:ring-inset sm:text-sm sm:leading-6',
            ...
            <div className="mt-10">
              <ContentEditable
                ...
                disabled={query.getOptions().enabled ? false : true}
                className={clsx(
                  'block w-auto rounded-md px-10 py-3 text-sm font-semibold shadow-sm focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2',
                  colors[colorKey].cta,
                )}
              />
            </div>
...
function SidebarDraggableItem({ hasActiveSub }: { hasActiveSub: boolean }) {
  return (
    <SidebarItem
      ...
      image="https://ablcaocvmgtcodafwvoe.supabase.co/storage/v1/object/public/components/contact_2-1699916317084.webp"
      name="Contact 2"
      Component={Contact2}
    />
  );
...
const colors: ColorObject = {
  ...
  red: {
    ...
    iconLabel: 'text-red-950/70 dark:text-red-50/70',
  ...
  orange: {
    ...
    iconLabel: 'text-orange-950/70 dark:text-orange-50/70',
  ...
  amber: {
    ...
    iconLabel: 'text-amber-950/70 dark:text-amber-50/70',
  ...
  yellow: {
    ...
    iconLabel: 'text-yellow-950/70 dark:text-yellow-50/70',
  ...
  lime: {
    ...
    iconLabel: 'text-lime-950/70 dark:text-lime-50/70',
  ...
  green: {
    ...
    iconLabel: 'text-green-950/70 dark:text-green-50/70',
  ...
  emerald: {
    ...
    iconLabel: 'text-emerald-950/70 dark:text-emerald-50/70',
  ...
  teal: {
    ...
    iconLabel: 'text-teal-950/70 dark:text-teal-50/70',
  ...
  cyan: {
    ...
    iconLabel: 'text-cyan-950/70 dark:text-cyan-50/70',
  ...
  sky: {
    ...
    iconLabel: 'text-sky-950/70 dark:text-sky-50/70',
  ...
  blue: {
    ...
    iconLabel: 'text-blue-950/70 dark:text-blue-50/70',
  ...
  indigo: {
    ...
    iconLabel: 'text-indigo-950/70 dark:text-indigo-50/70',
  ...
  violet: {
    ...
    iconLabel: 'text-violet-950/70 dark:text-violet-50/70',
  ...
  purple: {
    ...
    iconLabel: 'text-purple-950/70 dark:text-purple-50/70',
  ...
  fuchsia: {
    ...
    iconLabel: 'text-fuchsia-950/70 dark:text-fuchsia-50/70',
  ...
  pink: {
    ...
    iconLabel: 'text-pink-950/70 dark:text-pink-50/70',
  ...
  rose: {
    ...
    iconLabel: 'text-rose-950/70 dark:text-rose-50/70',
  ...
  return (
    <div className="${clsx(
      ...
      paddingArray.join(' '),
       ...
       <div className="grid grid-cols-1 items-center gap-14 md:grid-cols-2">
        <div className="flex flex-col gap-6">
          <h3 className="text-lg font-medium ${colors[textColorKey].tagline}">
          ...
          <div className="mt-4 flex flex-col gap-4">
            <div className="flex items-center gap-4">
              ...
              />
              <span className="text-base ${colors[textColorKey].iconLabel}">
        ...
        <div className="order-last">
          <form action="#" method="POST">
            <div className="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
              <div className="sm:col-span-2">
                ...
                <div className="mt-2.5">
                  <input
                    ...
                    id="name"
                    autoComplete="name"
                    className="block w-full rounded-md border-0 px-3.5 py-2 ring-1 ring-inset focus:ring-2 focus:ring-inset sm:text-sm sm:leading-6 ${colors[colorKey].input}"
                  />
                </div>
              </div>
              ...
              <div className="flex items-center space-x-2 sm:col-span-2">
                <input
                  ...
                  name="terms"
                  type="checkbox"
                  className="h-4 w-4 rounded ${colors[colorKey].checkboxInput}"
                />
                <label
                  htmlFor="terms"
                  className="block text-sm font-medium leading-6 ${colors[textColorKey].label}"
                >
                  I accept the{' '}
                  <Link href="#" className="text-sm underline">
                    terms and conditions
            ...
            <div className="mt-10">
              <button
                type="submit"
                className="block w-auto rounded-md px-10 py-3 text-sm font-semibold shadow-sm focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 ${colors[colorKey].cta}"
              >
                ${removeHtmlTags(cta)}
              </button>
            </div>
...
function prepForPageExport(
  ...
  importStatements.push(`import Contact2 from './components/Contact2';`);
  componentContent.push('<Contact2 />');
  return zip.file('components/Contact2.jsx', content);
}
