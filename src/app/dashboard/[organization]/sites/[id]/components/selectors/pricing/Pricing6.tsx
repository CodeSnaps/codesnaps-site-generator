          ...
          {tiers.map((tier) => (
            <div key={tier.id} className="flex flex-col space-y-8">
              ...
              {sections.map((section) => (
                <ul key={section.category} className="relative">
                  <h3
                    className={clsx(
                  ...
                  {section.features.map((feature: any, index: number) => (
                    ...
                    >
                      ...
                      >
                        ...
                        <div
                          className={clsx(
                            'absolute inset-x-px mx-auto mt-4 h-px',
...
function SidebarDraggableItem({ hasActiveSub }: { hasActiveSub: boolean }) {
  return (
    <SidebarItem
      ...
      image="https://ablcaocvmgtcodafwvoe.supabase.co/storage/v1/object/public/components/pricing_6-1699801115797.webp"
      name="Pricing 6"
      Component={Pricing6}
    />
  );
                    ...
                    <li
                      ...
                      className='flex w-full items-center justify-between p-4'>
                        <div className="text-sm ${colors[textColorKey].feature}">
                          {feature.name}
                          <div className="absolute inset-x-8 mx-auto mt-4 h-px ${colors[textColorKey].divider}" />
                        </div>
                        {typeof feature.tiers[tier.id] === 'string' ? (
...
function prepForPageExport(
  ...
  importStatements.push(`import Pricing6 from './components/Pricing6';`);
  componentContent.push('<Pricing6 />');
  return zip.file('components/Pricing6.jsx', content);
}
