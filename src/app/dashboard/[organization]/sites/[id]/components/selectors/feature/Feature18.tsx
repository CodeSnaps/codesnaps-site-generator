...
export const Feature18 = ({
  ...
  return (
    ...
    >
      ...
      <div className="relative order-last mx-auto mt-14 bg-neutral-300 pt-[56.25%]">
        <ReactPlayer
          width="100%"
          height="100%"
...
function SidebarDraggableItem({ hasActiveSub }: { hasActiveSub: boolean }) {
  return (
    <SidebarItem
      ...
      image="https://ablcaocvmgtcodafwvoe.supabase.co/storage/v1/object/public/components/feature_18-1699974207665.webp"
      name="Feature 18"
      Component={Feature18}
    />
  );
...
function prepForPageExport(
  ...
  importStatements.push(`import Feature18 from './components/Feature18';`);
  componentContent.push('<Feature18 />');
  return zip.file('components/Feature18.jsx', content);
}
