...
function SidebarDraggableItem({ hasActiveSub }: { hasActiveSub: boolean }) {
  return (
    <SidebarItem
      ...
      image="https://ablcaocvmgtcodafwvoe.supabase.co/storage/v1/object/public/components/hero_5-1699474787787.webp"
      name="Hero 5"
      Component={Hero5}
    />
  );
...
const imageColumns = ${imageColumnsString};
...
function prepForPageExport(
  ...
  importStatements.push(`import Hero5 from './components/Hero5';`);
  componentContent.push('<Hero5 />');
  return zip.file('components/Hero5.jsx', content);
}
