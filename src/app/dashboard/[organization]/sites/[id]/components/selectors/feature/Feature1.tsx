...
function SidebarDraggableItem({ hasActiveSub }: { hasActiveSub: boolean }) {
  return (
    <SidebarItem
      ...
      image="https://ablcaocvmgtcodafwvoe.supabase.co/storage/v1/object/public/components/feature_1-1699473452739.webp"
      name="Feature 1"
      Component={Feature1}
    />
  );
...
function prepForPageExport(
  ...
  importStatements.push(`import Feature1 from './components/Feature1';`);
  componentContent.push('<Feature1 />');
  return zip.file('components/Feature1.jsx', content);
}
