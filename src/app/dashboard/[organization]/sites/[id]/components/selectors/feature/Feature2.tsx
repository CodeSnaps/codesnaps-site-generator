...
function SidebarDraggableItem({ hasActiveSub }: { hasActiveSub: boolean }) {
  return (
    <SidebarItem
      ...
      image="https://ablcaocvmgtcodafwvoe.supabase.co/storage/v1/object/public/components/feature_2-1699473479589.webp"
      name="Feature 2"
      Component={Feature2}
    />
  );
...
function prepForPageExport(
  ...
  importStatements.push(`import Feature2 from './components/Feature2';`);
  componentContent.push('<Feature2 />');
  return zip.file('components/Feature2.jsx', content);
}
