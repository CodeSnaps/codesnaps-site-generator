      ...
      >
        ...
        >
          <div className="flex items-center gap-x-6">
            ...
            {/* NAVIGATION ITEMS */}
            <div className="hidden lg:items-center lg:gap-x-12 xl:flex">
              <ContentEditable
          ...
          <div className="hidden flex-1 items-center justify-end gap-x-4 xl:flex">
...
function SidebarDraggableItem({ hasActiveSub }: { hasActiveSub: boolean }) {
  return (
    <SidebarItem
      ...
      image="https://ablcaocvmgtcodafwvoe.supabase.co/storage/v1/object/public/components/navbar_10-1701386886725.webp"
      name="Navbar 10"
      Component={Navbar10}
    />
  );
...
function prepForPageExport(
  ...
  importStatements.push(`import Navbar10 from './components/Navbar10';`);
  componentContent.push('<Navbar10 />');
  return zip.file('components/Navbar10.jsx', content);
}
