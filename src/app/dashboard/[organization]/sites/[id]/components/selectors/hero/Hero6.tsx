...
function SidebarDraggableItem({ hasActiveSub }: { hasActiveSub: boolean }) {
  return (
    <SidebarItem
      ...
      image="https://ablcaocvmgtcodafwvoe.supabase.co/storage/v1/object/public/components/hero_6-1700431574656.webp"
      name="Hero 6"
      Component={Hero6}
    />
  );
...
function prepForPageExport(
  ...
  importStatements.push(`import Hero6 from './components/Hero6';`);
  componentContent.push('<Hero6 />');
  return zip.file('components/Hero6.jsx', content);
}
