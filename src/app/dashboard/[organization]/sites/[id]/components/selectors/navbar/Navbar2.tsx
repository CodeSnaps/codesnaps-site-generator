...
function SidebarDraggableItem({ hasActiveSub }: { hasActiveSub: boolean }) {
  return (
    <SidebarItem
      ...
      image="https://ablcaocvmgtcodafwvoe.supabase.co/storage/v1/object/public/components/navbar_2-1699474914969.webp"
      name="Navbar 2"
      Component={Navbar2}
    />
  );
...
function prepForPageExport(
  ...
  importStatements.push(`import Navbar2 from './components/Navbar2';`);
  componentContent.push('<Navbar2 />');
  return zip.file('components/Navbar2.jsx', content);
}
