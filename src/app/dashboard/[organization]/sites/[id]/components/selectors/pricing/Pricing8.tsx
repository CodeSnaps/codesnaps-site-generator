  ...
  return (
    ...
    >
                ...
                <div>
                  ...
                  <div className="mt-2 flex flex-col space-y-4">
                    <p className="flex items-baseline justify-center gap-x-1">
                      ...
                      <span className={colors[textColorKey].monthly}>/mo</span>
                    </p>
            ...
            <div key={tier.id} className="flex flex-col space-y-8">
              ...
              {sections.map((section) => (
                <ul
                  ...
                  className={clsx(
                    'rounded-md border px-4 py-6 relative',
                ...
                >
                  ...
                  <div
                    className={clsx(
                      '-inset-x-4 mx-auto h-px',
                      colors[textColorKey].categoryDivider,
                    )}
                  />
                  ...
                  {section.features.map((feature: any, index: number) => (
                    ...
                    >
                      ...
                      >
                        ...
                        <div
                          className={clsx(
                            'absolute inset-x-4 mx-auto mt-4 h-px',
                            colors[textColorKey].divider,
                          )}
                        />
                      </div>
      ...
      <div className="mt-24 hidden w-full xl:block">
        <table
          className={clsx(
            'w-full table-fixed border-separate border-spacing-x-8 rounded-xl border text-left',
            colors[textColorKey].border,
          )}
        >
            ...
            <Fragment>
              <tr>
                ...
                >
                  ...
                  <div
                    className={clsx(
                      'absolute -inset-x-4 mx-auto mt-4 h-px max-w-7xl',
                      colors[textColorKey].categoryDivider,
                    )}
                  />
                </th>
              ...
              <tr>
                <th
                  ...
                  colSpan={4}
                  className={clsx(
                    'pt-20 pb-6 text-lg font-semibold leading-6',
                    colors[textColorKey].heading,
                  )}
                >
                  <ContentEditable
...
function SidebarDraggableItem({ hasActiveSub }: { hasActiveSub: boolean }) {
  return (
    <SidebarItem
      ...
      image="https://ablcaocvmgtcodafwvoe.supabase.co/storage/v1/object/public/components/pricing_8-1699801295249.webp"
      name="Pricing 8"
      Component={Pricing8}
    />
  );
...
const colors: ColorObject = {
  slate: {
    ...
    categoryDivider: 'bg-slate-400 dark:bg-slate-500',
  ...
  gray: {
    ...
    categoryDivider: 'bg-gray-400 dark:bg-gray-500',
  ...
  zinc: {
    ...
    categoryDivider: 'bg-zinc-400 dark:bg-zinc-500',
  ...
  neutral: {
    ...
    categoryDivider: 'bg-neutral-400 dark:bg-neutral-500',
  ...
  stone: {
    ...
    divider: 'bg-stone-200 dark:bg-stone-800',
    categoryDivider: 'bg-stone-400 dark:bg-stone-500',
  ...
  red: {
    ...
    divider: 'bg-red-200 dark:bg-red-900',
    categoryDivider: 'bg-red-500 dark:bg-red-800',
    tableRowFirst: 'bg-red-200/60 dark:bg-red-950/60',
    tableRowSecond: 'bg-red-50/50 dark:bg-red-950/90',
    checkIcon: 'text-red-600 dark:text-red-400',
  ...
  orange: {
    ...
    divider: 'bg-orange-200 dark:bg-orange-900',
    categoryDivider: 'bg-orange-500 dark:bg-orange-800',
    tableRowFirst: 'bg-orange-200/60 dark:bg-orange-950/60',
    tableRowSecond: 'bg-orange-50/50 dark:bg-orange-950/90',
  ...
  amber: {
    ...
    divider: 'bg-amber-200 dark:bg-amber-900',
    categoryDivider: 'bg-amber-500 dark:bg-amber-800',
    tableRowFirst: 'bg-amber-200/60 dark:bg-amber-950/60',
    tableRowSecond: 'bg-amber-50/50 dark:bg-amber-950/90',
  ...
  yellow: {
    ...
    divider: 'bg-yellow-200 dark:bg-yellow-900',
    categoryDivider: 'bg-yellow-500 dark:bg-yellow-800',
    tableRowFirst: 'bg-yellow-200/60 dark:bg-yellow-950/60',
    tableRowSecond: 'bg-yellow-50/50 dark:bg-yellow-950/90',
    checkIcon: 'text-yellow-600 dark:text-yellow-400',
  ...
  lime: {
    border: 'border-lime-500 dark:border-lime-800',
    ...
    divider: 'bg-lime-200 dark:bg-lime-900',
    categoryDivider: 'bg-lime-500 dark:bg-lime-800',
    tableRowFirst: 'bg-lime-200/60 dark:bg-lime-950/60',
    tableRowSecond: 'bg-lime-50/50 dark:bg-lime-950/90',
    checkIcon: 'text-lime-600 dark:text-lime-400',
  ...
  green: {
    ...
    divider: 'bg-green-200 dark:bg-green-900',
    categoryDivider: 'bg-green-500 dark:bg-green-800',
    tableRowFirst: 'bg-green-200/60 dark:bg-green-950/60',
    tableRowSecond: 'bg-green-50/50 dark:bg-green-950/90',
  ...
  emerald: {
    ...
    divider: 'bg-emerald-200 dark:bg-emerald-900',
    categoryDivider: 'bg-emerald-500 dark:bg-emerald-800',
    tableRowFirst: 'bg-emerald-200/60 dark:bg-emerald-950/60',
    tableRowSecond: 'bg-emerald-50/50 dark:bg-emerald-950/90',
  ...
  teal: {
    border: 'border-teal-500 dark:border-teal-800',
    ...
    divider: 'bg-teal-200 dark:bg-teal-900',
    categoryDivider: 'bg-teal-500 dark:bg-teal-800',
    tableRowFirst: 'bg-teal-200/60 dark:bg-teal-950/60',
    tableRowSecond: 'bg-teal-50/50 dark:bg-teal-950/90',
  ...
  cyan: {
    border: 'border-cyan-500 dark:border-cyan-800',
    ...
    divider: 'bg-cyan-200 dark:bg-cyan-900',
    categoryDivider: 'bg-cyan-500 dark:bg-cyan-800',
    tableRowFirst: 'bg-cyan-200/60 dark:bg-cyan-950/60',
    tableRowSecond: 'bg-cyan-50/50 dark:bg-cyan-950/90',
    checkIcon: 'text-cyan-600 dark:text-cyan-400',
  ...
  sky: {
    border: 'border-sky-500 dark:border-sky-800',
    ...
    divider: 'bg-sky-200 dark:bg-sky-900',
    categoryDivider: 'bg-sky-500 dark:bg-sky-800',
    tableRowFirst: 'bg-sky-200/60 dark:bg-sky-950/60',
    tableRowSecond: 'bg-sky-50/50 dark:bg-sky-950/90',
  ...
  blue: {
    ...
    divider: 'bg-blue-200 dark:bg-blue-900',
    categoryDivider: 'bg-blue-500 dark:bg-blue-800',
    tableRowFirst: 'bg-blue-200/60 dark:bg-blue-950/60',
    tableRowSecond: 'bg-blue-50/50 dark:bg-blue-950/90',
  ...
  indigo: {
    ...
    divider: 'bg-indigo-200 dark:bg-indigo-900',
    categoryDivider: 'bg-indigo-500 dark:bg-indigo-800',
    tableRowFirst: 'bg-indigo-200/60 dark:bg-indigo-950/60',
    tableRowSecond: 'bg-indigo-50/50 dark:bg-indigo-950/90',
  ...
  violet: {
    ...
    divider: 'bg-violet-200 dark:bg-violet-900',
    categoryDivider: 'bg-violet-500 dark:bg-violet-800',
    tableRowFirst: 'bg-violet-200/60 dark:bg-violet-950/60',
    tableRowSecond: 'bg-violet-50/50 dark:bg-violet-950/90',
  ...
  purple: {
    ...
    divider: 'bg-purple-200 dark:bg-purple-900',
    categoryDivider: 'bg-purple-500 dark:bg-purple-800',
    tableRowFirst: 'bg-purple-200/60 dark:bg-purple-950/60',
    tableRowSecond: 'bg-purple-50/50 dark:bg-purple-950/90',
  ...
  fuchsia: {
    border: 'border-fuchsia-500 dark:border-fuchsia-800',
    ...
    divider: 'bg-fuchsia-200 dark:bg-fuchsia-900',
    categoryDivider: 'bg-fuchsia-500 dark:bg-fuchsia-800',
    tableRowFirst: 'bg-fuchsia-200/60 dark:bg-fuchsia-950/60',
    tableRowSecond: 'bg-fuchsia-50/50 dark:bg-fuchsia-950/90',
    checkIcon: 'text-fuchsia-600 dark:text-fuchsia-400',
  ...
  pink: {
    ...
    divider: 'bg-pink-200 dark:bg-pink-900',
    categoryDivider: 'bg-pink-500 dark:bg-pink-800',
    tableRowFirst: 'bg-pink-200/60 dark:bg-pink-950/60',
    tableRowSecond: 'bg-pink-50/50 dark:bg-pink-950/90',
    checkIcon: 'text-pink-600 dark:text-pink-400',
  ...
  rose: {
    ...
    divider: 'bg-rose-200 dark:bg-rose-900',
    categoryDivider: 'bg-rose-500 dark:bg-rose-800',
    tableRowFirst: 'bg-rose-200/60 dark:bg-rose-950/60',
    tableRowSecond: 'bg-rose-50/50 dark:bg-rose-950/90',
...
function generateComponentString({
    ...
    (tier) => `
  {
    ...
    id: '${tier.id}',
    href: '${tier.href}',
    price: '${removeHtmlTags(tier.price)}',
...
export default function Pricing() {
  return (
    <div className="${clsx(
        ...
        <div className="mt-14 flex flex-col space-y-14">
          {tiers.map((tier) => (
            <div key={tier.id} className="flex flex-col space-y-8">
              ...
              {sections.map((section) => (
                <ul key={section.category} className="rounded-md border px-4 py-6 ${colors[textColorKey].border}">
                  <h3 className="mb-4 text-base font-semibold ${colors[textColorKey].heading}">
                    {section.category}
                  </h3>
                  <div className="inset-x-8 mx-auto h-px ${colors[textColorKey].categoryDivider}" />

                  {section.features.map((feature, index) => (
                    <li
                      key={index}
                      className='flex w-full items-center justify-between p-4'>
                        <div className="text-sm ${colors[textColorKey].feature}">
                          {feature.name}
                          <div className="absolute inset-x-8 mx-auto mt-4 h-px sm:inset-x-10 lg:inset-x-12 ${colors[textColorKey].divider}" />
                        </div>
                        {typeof feature.tiers[tier.id] === 'string' ? (
      ...
      {/* DESKTOP */}
      <div className="mt-24 hidden w-full xl:block">
        <table className="w-full table-fixed border-separate border-spacing-x-8 rounded-xl border text-left ${colors[textColorKey].border}">
          <caption className="sr-only">Pricing plan comparison</caption>
          <colgroup>
            <col className="w-1/4" />
            <col className="w-1/4" />
            ...
            {sections.map((section, sectionIndex) => (
              <Fragment key={section.category}>
                <tr>
                  ...
                  >
                    {section.category}
                    <div className="absolute inset-x-8 mx-auto mt-4 h-px max-w-7xl ${colors[textColorKey].categoryDivider}" />
                  </th>
                </tr>
                ...
                {section.features.map((feature, index) => (
                  <tr key={index}>
                    ...
                    >
                      {feature.name}
                      <div className="absolute inset-x-8 mx-auto mt-4 h-px max-w-7xl ${colors[textColorKey].divider}" />
                    </th>
...
function prepForPageExport(
  ...
  importStatements.push(`import Pricing8 from './components/Pricing8';`);
  componentContent.push('<Pricing8 />');
  return zip.file('components/Pricing8.jsx', content);
}
