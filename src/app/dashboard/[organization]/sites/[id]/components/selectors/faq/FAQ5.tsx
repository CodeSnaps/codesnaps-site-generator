              ...
              <dt>
                ...
                >
                  <ContentEditable
                    ...
                    tagName="span"
                    disabled={query.getOptions().enabled ? false : true}
                    className="text-base font-semibold leading-7 outline-none focus:outline-offset-4 focus:outline-primary"
                  />
                </div>
              </dt>
...
function SidebarDraggableItem({ hasActiveSub }: { hasActiveSub: boolean }) {
  return (
    <SidebarItem
      ...
      image="https://ablcaocvmgtcodafwvoe.supabase.co/storage/v1/object/public/components/faq_5-1699971359131.webp"
      name="FAQ 5"
      Component={FAQ5}
    />
  );
...
function prepForPageExport(
  ...
  importStatements.push(`import FAQ5 from './components/FAQ5';`);
  componentContent.push('<FAQ5 />');
  return zip.file('components/FAQ5.jsx', content);
}
