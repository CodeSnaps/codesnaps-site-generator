...
function SidebarDraggableItem({ hasActiveSub }: { hasActiveSub: boolean }) {
  return (
    <SidebarItem
      ...
      image="https://ablcaocvmgtcodafwvoe.supabase.co/storage/v1/object/public/components/feature_6-1699473668939.webp"
      name="Feature 6"
      Component={Feature6}
    />
  );
    ...
    <div className="${clsx(
      ...
      <div className="flex flex-col space-y-7 text-center">
        ...
        <div className="flex justify-center space-x-8">
          <Link
            href="#"
            className="rounded-md px-10 py-3 text-sm font-semibold shadow-sm focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 ${
              colors[colorKey].primaryCta
            }"
          >
          ...
          <Link
            href="#"
            className="rounded-md px-10 py-3 text-sm font-semibold shadow-sm ring-1 ring-inset focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 ${
              colors[colorKey].primaryCta
            }"
          >
...
function prepForPageExport(
  ...
  importStatements.push(`import Feature6 from './components/Feature6';`);
  componentContent.push('<Feature6 />');
  return zip.file('components/Feature6.jsx', content);
}
