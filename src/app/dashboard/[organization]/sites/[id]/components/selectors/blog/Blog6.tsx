            ...
            <div className="mt-6 flex items-center">
              ...
              >
                <ContentEditable
                  ...
                  onChange={(e) =>
                    setProp((props: { featuredPostCta: string }) => {
              ...
              <div className="py-8 lg:py-10">
                <div className="flex items-center space-x-4">
                  ...
                  <ContentEditable
                    ...
                    onChange={(e) =>
                      setProp((props: any) => {
                        props.posts[post.id - 1].metadata.date = e.target.value;
                      })
                    }
                    tagName="time"
                    disabled={query.getOptions().enabled ? false : true}
...
function SidebarDraggableItem({ hasActiveSub }: { hasActiveSub: boolean }) {
  return (
    <SidebarItem
      ...
      image="https://ablcaocvmgtcodafwvoe.supabase.co/storage/v1/object/public/components/blog_6-1704322790693.webp?t=2024-03-23T16%3A08%3A48.894Z"
      name="Blog 6"
      Component={Blog6}
    />
  );
...
function prepForPageExport(
  ...
  importStatements.push(`import Blog6 from './components/Blog6';`);
  componentContent.push('<Blog6 />');
  return zip.file('components/Blog6.jsx', content);
}
