...
export const Hero7 = ({
  ...
  primaryCta = '',
  secondaryCta = '',
  paddingArray = ['px-4', 'sm:px-6', 'lg:px-8', 'pb-20'],
  marginArray = ['mx-auto', 'mt-14'],
  maxWidth = 'max-w-7xl',
  color = 'amber',
  textColor = 'neutral',
...
function SidebarDraggableItem({ hasActiveSub }: { hasActiveSub: boolean }) {
  return (
    <SidebarItem
      ...
      image="https://ablcaocvmgtcodafwvoe.supabase.co/storage/v1/object/public/components/hero_7-1700431681089.webp"
      name="Hero 7"
      Component={Hero7}
    />
  );
  ...
  return (
     <div>
      ...
      <div className="${clsx(
        ...
        <div className="grid gap-7 xl:grid-cols-2">
          <h1 className="text-4xl font-bold leading-tight tracking-wide xl:text-5xl xl:leading-tight ${colors[textColorKey].heading}">
...
function prepForPageExport(
  ...
  importStatements.push(`import Hero7 from './components/Hero7';`);
  componentContent.push('<Hero7 />');
  return zip.file('components/Hero7.jsx', content);
}
