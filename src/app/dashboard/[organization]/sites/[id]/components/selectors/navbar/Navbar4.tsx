          ...
          >
            ...
            <div className="mt-6 flow-root">
              <div className="-my-6">
                <div
                  className={clsx(
                    'flex flex-col space-y-8 divide-y py-6',
                ...
                >
                  {navigation.map((item) => (
                    <div key={item.name}>
                      <span
                        className={clsx(
                          '-mx-3 mt-4 block px-3 py-2 text-base font-semibold leading-7',
                          colors[textColorKey].links,
                        )}
                      >
                        {item.name}
...
function SidebarDraggableItem({ hasActiveSub }: { hasActiveSub: boolean }) {
  return (
    <SidebarItem
      ...
      image="https://ablcaocvmgtcodafwvoe.supabase.co/storage/v1/object/public/components/navbar_4-1700253452156.webp"
      name="Navbar 4"
      Component={Navbar4}
    />
  );
...
function ToolbarSettings() {
  ...
  return (
    <ToolbarSettingsForm hasMarginAndPadding={false}>
      <AccordionItem value="dropdownOne">
        <AccordionTrigger>
          ...
          <div className="flex flex-col gap-4 justify-between">
            <div className="flex flex-col gap-1">
              ...
              <input
                type="text"
                id="linkOne"
                value={navigation[0].name}
                onChange={(e) =>
                  setProp((props: any) => {
                    props.navigation[0].name = (
            ...
            <div className="flex flex-col gap-1">
              ...
              <input
                type="text"
                id="linkOne"
                value={navigation[0].dropdownItems[0].name}
                onChange={(e) =>
                  setProp((props: any) => {
                    props.navigation[0].dropdownItems[0].name = (
                      e.target as HTMLInputElement
                    ).value;
                  })
                }
            ...
            <div className="flex flex-col gap-1">
              ...
              <input
                type="text"
                id="linkOne"
                value={navigation[0].dropdownItems[1].name}
                onChange={(e) =>
                  setProp((props: any) => {
                    props.navigation[0].dropdownItems[1].name = (
                      e.target as HTMLInputElement
                    ).value;
                  })
                }
            ...
            <div className="flex flex-col gap-1">
              ...
              <input
                type="text"
                id="linkOne"
                value={navigation[0].dropdownItems[2].name}
                onChange={(e) =>
                  setProp((props: any) => {
                    props.navigation[0].dropdownItems[2].name = (
                      e.target as HTMLInputElement
                    ).value;
                  })
                }
      ...
      <AccordionItem value="dropdownTwo">
        <AccordionTrigger>
          ...
          <div className="flex flex-col gap-4 justify-between">
            <div className="flex flex-col gap-1">
              ...
              <input
                type="text"
                id="linkOne"
                value={navigation[1].name}
                onChange={(e) =>
                  setProp((props: any) => {
                    props.navigation[1].name = (
                      e.target as HTMLInputElement
                    ).value;
                  })
                }
            ...
            <div className="flex flex-col gap-1">
              ...
              <input
                type="text"
                id="linkOne"
                value={navigation[1].dropdownItems[0].name}
                onChange={(e) =>
                  setProp((props: any) => {
                    props.navigation[1].dropdownItems[0].name = (
                      e.target as HTMLInputElement
                    ).value;
                  })
                }
            ...
            <div className="flex flex-col gap-1">
              ...
              <input
                type="text"
                id="linkOne"
                value={navigation[1].dropdownItems[1].name}
                onChange={(e) =>
                  setProp((props: any) => {
                    props.navigation[1].dropdownItems[1].name = (
                      e.target as HTMLInputElement
                    ).value;
                  })
                }
            ...
            <div className="flex flex-col gap-1">
              ...
              <input
                type="text"
                id="linkOne"
                value={navigation[1].dropdownItems[2].name}
                onChange={(e) =>
                  setProp((props: any) => {
                    props.navigation[1].dropdownItems[2].name = (
                      e.target as HTMLInputElement
                    ).value;
                  })
                }
            ...
            <div className="flex flex-col gap-1">
              <TextFieldLabel htmlFor="linkOne">Dropdown Link 4</TextFieldLabel>
              <input
                type="text"
                id="linkOne"
                value={navigation[1].dropdownItems[3].name}
                onChange={(e) =>
                  setProp((props: any) => {
                    props.navigation[1].dropdownItems[3].name = (
                      e.target as HTMLInputElement
                    ).value;
                  })
                }
            ...
            <div className="flex flex-col gap-1">
              <TextFieldLabel htmlFor="linkOne">Dropdown Link 5</TextFieldLabel>
              <input
                type="text"
                id="linkOne"
                value={navigation[1].dropdownItems[4].name}
                onChange={(e) =>
                  setProp((props: any) => {
                    props.navigation[1].dropdownItems[4].name = (
                      e.target as HTMLInputElement
                    ).value;
                  })
                }
      ...
      <AccordionItem value="dropdownThree">
        <AccordionTrigger>
          <h3 className="text-sm font-medium leading-6 text-gray-900 dark:text-gray-50 mt-6">
            Dropdown #3
          </h3>
          ...
          <div className="flex flex-col gap-4 justify-between">
            ...
            <div className="flex flex-col gap-1">
              ...
              <input
                type="text"
                id="linkOne"
                value={navigation[2].dropdownItems[3].name}
                onChange={(e) =>
                  setProp((props: any) => {
                    props.navigation[2].dropdownItems[3].name = (
                      e.target as HTMLInputElement
                    ).value;
                  })
                }
...
const colors: ColorObject = {
  ...
  violet: {
    ...
    dropdown: 'bg-white ring-black/5 dark:bg-violet-950 dark:bg-violet-950',
...
function generateComponentString({
  ...
  { name: '${removeHtmlTags(navigation[0].name)}', dropdownItems: [
        { name: '${navigation[0].dropdownItems && navigation[0].dropdownItems[0] ? removeHtmlTags(navigation[0].dropdownItems[0].name) : 'Item #1'}', href: '#' },
        { name: '${navigation[0].dropdownItems && navigation[0].dropdownItems[1] ? removeHtmlTags(navigation[0].dropdownItems[1].name) : 'Item #2'}', href: '#' },
        { name: '${navigation[0].dropdownItems && navigation[0].dropdownItems[2] ? removeHtmlTags(navigation[0].dropdownItems[2].name) : 'Item #3'}', href: '#' },
    ],
  },
  { name: '${removeHtmlTags(navigation[1].name)}', dropdownItems: [
        { name: '${navigation[1].dropdownItems && navigation[1].dropdownItems[0] ? removeHtmlTags(navigation[1].dropdownItems[0].name) : 'Item #1'}', href: '#' },
        { name: '${navigation[1].dropdownItems && navigation[1].dropdownItems[1] ? removeHtmlTags(navigation[1].dropdownItems[1].name) : 'Item #2'}', href: '#' },
        { name: '${navigation[1].dropdownItems && navigation[1].dropdownItems[2] ? removeHtmlTags(navigation[1].dropdownItems[2].name) : 'Item #3'}', href: '#' },
        { name: '${navigation[1].dropdownItems && navigation[1].dropdownItems[3] ? removeHtmlTags(navigation[1].dropdownItems[3].name) : 'Item #4'}', href: '#' },
        { name: '${navigation[1].dropdownItems && navigation[1].dropdownItems[4] ? removeHtmlTags(navigation[1].dropdownItems[4].name) : 'Item #5'}', href: '#' },
    ],
  },
    {
        name: '${removeHtmlTags(navigation[2].name)}',
        dropdownItems: [
        { name: '${navigation[2].dropdownItems && navigation[2].dropdownItems[0] ? removeHtmlTags(navigation[2].dropdownItems[0].name) : 'Item #1'}', href: '#' },
        { name: '${navigation[2].dropdownItems && navigation[2].dropdownItems[1] ? removeHtmlTags(navigation[2].dropdownItems[1].name) : 'Item #2'}', href: '#' },
        { name: '${navigation[2].dropdownItems && navigation[2].dropdownItems[2] ? removeHtmlTags(navigation[2].dropdownItems[2].name) : 'Item #3'}', href: '#' },
         { name: '${navigation[2].dropdownItems && navigation[2].dropdownItems[3] ? removeHtmlTags(navigation[2].dropdownItems[3].name) : 'Item #4'}', href: '#' },
        ],
    },
  ]`;
    ...
    <header className="absolute inset-x-0 top-0 z-50 border-b p-6 ${colors[colorKey].header}">
      ...
      >
        ...
        <Dialog.Panel className="fixed inset-y-0 right-0 z-50 w-full overflow-y-auto px-6 py-6 sm:max-w-sm sm:ring-1 ${colors[colorKey].dialogPanel}">
          ...
          <div className="mt-6 flow-root">
            <div className="-my-6">
              <div className="flex flex-col space-y-8 divide-y py-6 ${colors[colorKey].mobileDivide}">
                {navigation.map((item) => (
                  <div key={item.name}>
                    <span className="-mx-3 mt-4 block px-3 py-2 text-base font-semibold leading-7 ${colors[textColorKey].links}">
                      {item.name}
                    </span>
                    ...
                    {item.dropdownItems.map((item) => (
                      <Link
                        key={item.name}
                        href={item.href}
                        className="-mx-3 block rounded-lg px-3 py-2 text-sm font-medium leading-7 ${colors[colorKey].mobileDropdownLinks} ${colors[colorKey].mobileHover}"
                      >
                        {item.name}
                      </Link>
                    ))}
...
function prepForPageExport(
  ...
  importStatements.push(`import Navbar4 from './components/Navbar4';`);
  componentContent.push('<Navbar4 />');
  return zip.file('components/Navbar4.jsx', content);
}
