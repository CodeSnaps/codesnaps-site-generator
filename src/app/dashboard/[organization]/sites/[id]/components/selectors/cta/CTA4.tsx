...
function SidebarDraggableItem({ hasActiveSub }: { hasActiveSub: boolean }) {
  return (
    <SidebarItem
      ...
      image="https://ablcaocvmgtcodafwvoe.supabase.co/storage/v1/object/public/components/cta_4-1699969766223.webp"
      name="CTA 4"
      Component={CTA4}
    />
  );
...
function prepForPageExport(
  ...
  importStatements.push(`import CTA4 from './components/CTA4';`);
  componentContent.push('<CTA4 />');
  return zip.file('components/CTA4.jsx', content);
}
