...
function SidebarDraggableItem({ hasActiveSub }: { hasActiveSub: boolean }) {
  return (
    <SidebarItem
      ...
      image="https://ablcaocvmgtcodafwvoe.supabase.co/storage/v1/object/public/components/pricing_3-1699646859014.webp"
      name="Pricing 3"
      Component={Pricing3}
    />
  );
...
function prepForPageExport(
  ...
  importStatements.push(`import Pricing3 from './components/Pricing3';`);
  componentContent.push('<Pricing3 />');
  return zip.file('components/Pricing3.jsx', content);
}
