...
function SidebarDraggableItem({ hasActiveSub }: { hasActiveSub: boolean }) {
  return (
    <SidebarItem
      ...
      image="https://ablcaocvmgtcodafwvoe.supabase.co/storage/v1/object/public/components/contact_3-1699916439682.webp"
      name="Contact 3"
      Component={Contact3}
    />
  );
...
function prepForPageExport(
  ...
  importStatements.push(`import Contact3 from './components/Contact3';`);
  componentContent.push('<Contact3 />');
  return zip.file('components/Contact3.jsx', content);
}
