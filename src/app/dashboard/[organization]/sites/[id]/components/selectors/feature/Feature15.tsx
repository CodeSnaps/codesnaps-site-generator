...
function SidebarDraggableItem({ hasActiveSub }: { hasActiveSub: boolean }) {
  return (
    <SidebarItem
      ...
      image="https://ablcaocvmgtcodafwvoe.supabase.co/storage/v1/object/public/components/feature_15-1699973895768.webp"
      name="Feature 15"
      Component={Feature15}
    />
  );
...
function prepForPageExport(
  ...
  importStatements.push(`import Feature15 from './components/Feature15';`);
  componentContent.push('<Feature15 />');
  return zip.file('components/Feature15.jsx', content);
}
