    ...
    <ToolbarSettingsForm>
        ...
        <AccordionContent>
          <div className="flex flex-col gap-4">
            <div className="flex flex-col gap-1">
              <TextFieldLabel htmlFor="tier1-features1">
                Feature #1
              </TextFieldLabel>
              <input
                type="text"
                id="tier1-features1"
                value={tiers[0].features[0]}
                onChange={(e) => {
                  setProp(
                    (props: any) =>
                      (props.tiers[0].features[0] = e.target.value),
                  );
                }}
            ...
            <div className="flex flex-col gap-1">
              <TextFieldLabel htmlFor="tier1-features2">
                Feature #2
              </TextFieldLabel>
              <input
                type="text"
                id="tier1-features2"
                value={tiers[0].features[1]}
                onChange={(e) => {
                  setProp(
                    (props: any) =>
                      (props.tiers[0].features[1] = e.target.value),
                  );
                }}
                className="flex h-10 w-full rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground disabled:cursor-not-allowed disabled:opacity-50 text-neutral-800 dark:text-neutral-100"
              />
            ...
            <div className="flex flex-col gap-1">
              <TextFieldLabel htmlFor="tier1-features3">
                Feature #3
              </TextFieldLabel>
              <input
                type="text"
                id="tier1-features3"
                value={tiers[0].features[2]}
                onChange={(e) => {
                  setProp(
                    (props: any) =>
                      (props.tiers[0].features[2] = e.target.value),
                  );
                }}
                className="flex h-10 w-full rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground disabled:cursor-not-allowed disabled:opacity-50 text-neutral-800 dark:text-neutral-100"
              />
      ...
      <AccordionItem value="tier2">
        ...
        <AccordionContent>
          <div className="flex flex-col gap-4">
            <div className="flex flex-col gap-1">
              <TextFieldLabel htmlFor="tier2-features1">
                Feature #1
              </TextFieldLabel>
              <input
                type="text"
                id="tier2-features1"
                value={tiers[1].features[0]}
                onChange={(e) => {
                  setProp(
                    (props: any) =>
                      (props.tiers[1].features[0] = e.target.value),
                  );
                }}
                className="flex h-10 w-full rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground disabled:cursor-not-allowed disabled:opacity-50 text-neutral-800 dark:text-neutral-100"
              />
            ...
            <div className="flex flex-col gap-1">
              <TextFieldLabel htmlFor="tier2-features2">
                Feature #2
              </TextFieldLabel>
              <input
                type="text"
                id="tier2-features2"
                value={tiers[1].features[1]}
                onChange={(e) => {
                  setProp(
                    (props: any) =>
                      (props.tiers[1].features[1] = e.target.value),
                  );
                }}
                className="flex h-10 w-full rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground disabled:cursor-not-allowed disabled:opacity-50 text-neutral-800 dark:text-neutral-100"
              />
            ...
            <div className="flex flex-col gap-1">
              <TextFieldLabel htmlFor="tier2-features3">
                Feature #3
              </TextFieldLabel>
              <input
                type="text"
                id="tier2-features3"
                value={tiers[1].features[2]}
                onChange={(e) => {
                  setProp(
                    (props: any) =>
                      (props.tiers[1].features[2] = e.target.value),
                  );
                }}
                className="flex h-10 w-full rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground disabled:cursor-not-allowed disabled:opacity-50 text-neutral-800 dark:text-neutral-100"
              />
            ...
            <div className="flex flex-col gap-1">
              <TextFieldLabel htmlFor="tier2-features4">
                Feature #4
              </TextFieldLabel>
              <input
                type="text"
                id="tier2-features4"
                value={tiers[1].features[3]}
                onChange={(e) => {
                  setProp(
                    (props: any) =>
                      (props.tiers[1].features[3] = e.target.value),
                  );
                }}
                className="flex h-10 w-full rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground disabled:cursor-not-allowed disabled:opacity-50 text-neutral-800 dark:text-neutral-100"
              />
      ...
      <AccordionItem value="tier3">
        ...
        <AccordionContent>
          <div className="flex flex-col gap-4">
            <div className="flex flex-col gap-1">
              <TextFieldLabel htmlFor="tier3-features1">
                Feature #1
              </TextFieldLabel>
              <input
                type="text"
                id="tier3-features1"
                value={tiers[2].features[0]}
                onChange={(e) => {
                  setProp(
                    (props: any) =>
                      (props.tiers[2].features[0] = e.target.value),
                  );
                }}
                className="flex h-10 w-full rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground disabled:cursor-not-allowed disabled:opacity-50 text-neutral-800 dark:text-neutral-100"
              />
            ...
            <div className="flex flex-col gap-1">
              <TextFieldLabel htmlFor="tier3-features2">
                Feature #2
              </TextFieldLabel>
              <input
                type="text"
                id="tier3-features2"
                value={tiers[2].features[1]}
                onChange={(e) => {
                  setProp(
                    (props: any) =>
                      (props.tiers[2].features[1] = e.target.value),
                  );
                }}
                className="flex h-10 w-full rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground disabled:cursor-not-allowed disabled:opacity-50 text-neutral-800 dark:text-neutral-100"
              />
            ...
            <div className="flex flex-col gap-1">
              <TextFieldLabel htmlFor="tier3-features3">
                Feature #3
              </TextFieldLabel>
              <input
                type="text"
                id="tier3-features3"
                value={tiers[2].features[2]}
                onChange={(e) => {
                  setProp(
                    (props: any) =>
                      (props.tiers[2].features[2] = e.target.value),
                  );
                }}
                className="flex h-10 w-full rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground disabled:cursor-not-allowed disabled:opacity-50 text-neutral-800 dark:text-neutral-100"
              />
            ...
            <div className="flex flex-col gap-1">
              <TextFieldLabel htmlFor="tier3-features4">
                Feature #4
              </TextFieldLabel>
              <input
                type="text"
                id="tier3-features4"
                value={tiers[2].features[3]}
                onChange={(e) => {
                  setProp(
                    (props: any) =>
                      (props.tiers[2].features[3] = e.target.value),
                  );
                }}
                className="flex h-10 w-full rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground disabled:cursor-not-allowed disabled:opacity-50 text-neutral-800 dark:text-neutral-100"
              />
            ...
            <div className="flex flex-col gap-1">
              <TextFieldLabel htmlFor="tier3-features5">
                Feature #4
              </TextFieldLabel>
              <input
                type="text"
                id="tier3-features5"
                value={tiers[2].features[4]}
                onChange={(e) => {
                  setProp(
                    (props: any) =>
                      (props.tiers[2].features[4] = e.target.value),
                  );
                }}
                className="flex h-10 w-full rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground disabled:cursor-not-allowed disabled:opacity-50 text-neutral-800 dark:text-neutral-100"
              />
...
function generateComponentString({
  ...
  const teamString = `[${mappedTiers.join(',\n')}]`;

  let content: string;

  const nextContent = `import Link from 'next/link';

const tiers = ${teamString};
