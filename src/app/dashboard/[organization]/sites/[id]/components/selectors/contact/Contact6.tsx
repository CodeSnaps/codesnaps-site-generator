        ...
        <div className="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
          ...
          <div className="sm:col-span-2">
            ...
            <select
              ...
              name="contactReason"
              className={clsx(
                '"mt-2 block w-full rounded-md border-0 bg-white px-3.5 py-2.5 ring-1 ring-inset focus:ring-2 focus:ring-inset sm:text-sm sm:leading-6 dark:text-white',
                colors[colorKey].input,
              )}
              defaultValue="First Reason"
            >
              <option>{firstReason}</option>
              <option>{secondReason}</option>
              <option>{thirdReason}</option>
            </select>
          </div>
...
function SidebarDraggableItem({ hasActiveSub }: { hasActiveSub: boolean }) {
  return (
    <SidebarItem
      ...
      image="https://ablcaocvmgtcodafwvoe.supabase.co/storage/v1/object/public/components/contact_6-1699916785051.webp"
      name="Contact 6"
      Component={Contact6}
    />
  );
...
function ToolbarSettings() {
  const {
    ...
    firstReason: node.data.props.firstReason,
    secondReason: node.data.props.secondReason,
    thirdReason: node.data.props.thirdReason,
        ...
        <AccordionContent>
          <div className="flex flex-col gap-4 justify-between">
            <div className="flex flex-col gap-1">
              <TextFieldLabel htmlFor="firstReason">
                First Reason
              </TextFieldLabel>
              <input
                type="text"
                ...
                value={firstReason}
                onChange={(e) =>
                  setProp((props: { firstReason: string }) => {
                    props.firstReason = e.target.value;
                  })
                }
            ...
            <div className="flex flex-col gap-1">
              <TextFieldLabel htmlFor="secondReason">
                Second Reason
              </TextFieldLabel>
              <input
                type="text"
                ...
                value={secondReason}
                onChange={(e) =>
                  setProp((props: { secondReason: string }) => {
                    props.secondReason = e.target.value;
                  })
                }
                className="flex h-10 w-full rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground disabled:cursor-not-allowed disabled:opacity-50 text-neutral-800 dark:text-neutral-100"
              />
            ...
            <div className="flex flex-col gap-1">
              <TextFieldLabel htmlFor="thirdReason">
                Third Reason
              </TextFieldLabel>
              <input
                type="text"
                ...
                value={thirdReason}
                onChange={(e) =>
                  setProp((props: { thirdReason: string }) => {
                    props.thirdReason = e.target.value;
                  })
                }
                className="flex h-10 w-full rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground disabled:cursor-not-allowed disabled:opacity-50 text-neutral-800 dark:text-neutral-100"
              />
        ...
        <div className="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
          ...
          <div className="sm:col-span-2">
            ...
            <select
              id="contactReason"
              name="contactReason"
              className="mt-2 block w-full rounded-md border-0 bg-white px-3.5 py-2.5 ring-1 ring-inset focus:ring-2 focus:ring-inset sm:text-sm sm:leading-6 dark:text-white ${colors[colorKey].input}"
              defaultValue="First Reason"
            >
              <option>${removeHtmlTags(firstReason)}</option>
              <option>${removeHtmlTags(secondReason)}</option>
              <option>${removeHtmlTags(thirdReason)}</option>
            </select>
          </div>
...
function prepForPageExport(
  ...
  importStatements.push(`import Contact6 from './components/Contact6';`);
  componentContent.push('<Contact6 />');
  return zip.file('components/Contact6.jsx', content);
}
