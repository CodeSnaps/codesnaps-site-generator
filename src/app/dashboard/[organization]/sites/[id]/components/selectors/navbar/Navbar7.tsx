...
function SidebarDraggableItem({ hasActiveSub }: { hasActiveSub: boolean }) {
  return (
    <SidebarItem
      ...
      image="https://ablcaocvmgtcodafwvoe.supabase.co/storage/v1/object/public/components/navbar_7-1701386388754.webp"
      name="Navbar 7"
      Component={Navbar7}
    />
  );
...
function prepForPageExport(
  ...
  importStatements.push(`import Navbar7 from './components/Navbar7';`);
  componentContent.push('<Navbar7 />');
  return zip.file('components/Navbar7.jsx', content);
}
