...
function SidebarDraggableItem({ hasActiveSub }: { hasActiveSub: boolean }) {
  return (
    <SidebarItem
      ...
      image="https://ablcaocvmgtcodafwvoe.supabase.co/storage/v1/object/public/components/feature_3-1699473512140.webp"
      name="Feature 3"
      Component={Feature3}
    />
  );
...
const colors: ColorObject = {
  ...
  red: {
    ...
    featureName: 'text-red-800 dark:text-red-100',
  ...
  orange: {
    ...
    featureName: 'text-orange-800 dark:text-orange-100',
  ...
  amber: {
    ...
    featureName: 'text-amber-800 dark:text-amber-100',
  ...
  yellow: {
    ...
    featureName: 'text-yellow-800 dark:text-yellow-100',
  ...
  lime: {
    ...
    featureName: 'text-lime-800 dark:text-lime-100',
  ...
  green: {
    ...
    featureName: 'text-green-800 dark:text-green-100',
  ...
  emerald: {
    ...
    featureName: 'text-emerald-800 dark:text-emerald-100',
  ...
  teal: {
    ...
    featureName: 'text-teal-800 dark:text-teal-100',
  ...
  cyan: {
    ...
    featureName: 'text-cyan-800 dark:text-cyan-100',
  ...
  sky: {
    ...
    featureName: 'text-sky-800 dark:text-sky-100',
  ...
  blue: {
    ...
    featureName: 'text-blue-800 dark:text-blue-100',
  ...
  indigo: {
    ...
    featureName: 'text-indigo-800 dark:text-indigo-100',
  ...
  violet: {
    ...
    featureName: 'text-violet-800 dark:text-violet-100',
  ...
  purple: {
    ...
    featureName: 'text-purple-800 dark:text-purple-100',
  ...
  fuchsia: {
    ...
    featureName: 'text-fuchsia-800 dark:text-fuchsia-100',
  ...
  pink: {
    ...
    featureName: 'text-pink-800 dark:text-pink-100',
  ...
  rose: {
    ...
    featureName: 'text-rose-800 dark:text-rose-100',
...
function prepForPageExport(
  ...
  importStatements.push(`import Feature3 from './components/Feature3';`);
  componentContent.push('<Feature3 />');
  return zip.file('components/Feature3.jsx', content);
}
