          ...
          <div className="flex flex-col gap-3">
            ...
            >
              <ContentEditable
                ...
                onChange={(e) =>
                  setProp(
                    (props: { addressCta: string }) =>
                      (props.addressCta = e.target.value),
                  )
                }
                tagName="span"
                disabled={query.getOptions().enabled ? false : true}
              ...
              />
              <ChevronIcon
                className={clsx('h-4 w-4', colors[textColorKey].icon)}
              />
            </div>
          </div>
        </div>
...
function SidebarDraggableItem({ hasActiveSub }: { hasActiveSub: boolean }) {
  return (
    <SidebarItem
      ...
      image="https://ablcaocvmgtcodafwvoe.supabase.co/storage/v1/object/public/components/contact_4-1699916532329.webp"
      name="Contact 4"
      Component={Contact4}
    />
  );
...
function ToolbarSettings() {
  const {
    ...
    addressCta: node.data.props.addressCta,
    ...
    <div className="${clsx(
      ...
      paddingArray.join(' '),
       ...
       <div className="grid grid-cols-1 items-center gap-14 md:grid-cols-2">
        ...
        <div className="order-last grid gap-8 md:grid-cols-2">
          <div className="flex flex-col gap-3">
            <h3 className="flex items-center gap-2 text-lg font-semibold ${colors[textColorKey].heading}">
              <MailIcon
                aria-hidden="true"
            ...
            <Link
              href="mailto:${removeHtmlTags(email)}"
              className="text-base ${colors[textColorKey].iconLabel}"
            >
          ...
          <div className="flex flex-col gap-3">
            ...
            <Link
              href="#"
              className="flex items-center gap-2 text-base ${colors[textColorKey].iconLabel}"
            >
              ${removeHtmlTags(addressCta)}
              <ChevronIcon className="h-4 w-4 ${colors[textColorKey].icon}" />
            </Link>
          </div>
        </div>
      </div>
...
function prepForPageExport(
  ...
  importStatements.push(`import Contact4 from './components/Contact4';`);
  componentContent.push('<Contact4 />');
  return zip.file('components/Contact4.jsx', content);
}
...
Contact4.craft = {
  props: {
    ...
    emailDescription: 'Email us',
    phone: '+1 (555) 123-4567',
    phoneDescription: 'Call us',
    addressCta: 'Get directions',
    addressDescription: 'Visit us',
    cta: 'Submit',
    paddingArray: ['px-4', 'sm:px-6', 'lg:px-8'],
    marginArray: ['mx-auto', 'mt-24', 'sm:mt-32', 'md:mt-40'],
    maxWidth: 'max-w-7xl',
