  ...
  return (
    ...
    >
      <div className="grid grid-cols-1 items-center gap-14 lg:grid-cols-2">
        <div className="order-last mx-auto max-w-xl xl:order-first">
          <Image
            priority
...
function SidebarDraggableItem({ hasActiveSub }: { hasActiveSub: boolean }) {
  return (
    <SidebarItem
      ...
      image="https://ablcaocvmgtcodafwvoe.supabase.co/storage/v1/object/public/components/feature_13-1699973506581.webp"
      name="Feature 13"
      Component={Feature13}
    />
  );
...
function prepForPageExport(
  ...
  importStatements.push(`import Feature13 from './components/Feature13';`);
  componentContent.push('<Feature13 />');
  return zip.file('components/Feature13.jsx', content);
}
