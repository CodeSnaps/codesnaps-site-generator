...
export const Footer3 = ({
  ...
  newsletterCategoryLabel?: string;
  ...
  return (
    <footer aria-labelledby="footer-heading">
      ...
      >
        ...
        <div
          className={clsx(
            'mt-16 flex flex-col justify-between space-y-6 border-t pt-4 sm:mt-20 md:flex-row md:items-end lg:mt-24',
...
function SidebarDraggableItem({ hasActiveSub }: { hasActiveSub: boolean }) {
  return (
    <SidebarItem
      ...
      image="https://ablcaocvmgtcodafwvoe.supabase.co/storage/v1/object/public/components/footer_3-1700069837318.webp"
      name="Footer 3"
      Component={Footer3}
    />
  );
...
function ToolbarSettings() {
  const {
    ...
    newsletterCategoryLabel: node.data.props.newsletterCategoryLabel,
    ...
    <footer aria-labelledby="footer-heading">
      ...
      <div className="${clsx(
        ...
        <div className="flex flex-col justify-between gap-10 md:gap-14 xl:flex-row">
          ...
          <div className="flex max-w-xs flex-col gap-4 sm:max-w-lg">
            <h3 className="text-sm font-semibold leading-6 ${colors[textColorKey].linksLabel}">
              ${removeHtmlTags(newsletterCategoryLabel)}
            </h3>

            <p className="text-sm ${colors[textColorKey].newsletterHeading}">
        ...
        <div className="mt-16 flex flex-col justify-between space-y-6 border-t pt-4 sm:mt-20 md:flex-row md:items-end lg:mt-24 ${colors[textColorKey].border}">
          <div className="flex space-x-6">
          ...
          <ul role="list" className="mt-2 flex gap-4 lg:mt-6">
            {navigation.social.map((item) => (
              <li key={item.name}>
                <Link
                  href={item.href}
                  className="group flex items-center ${colors[colorKey].icon}"
                >
...
function prepForPageExport(
  ...
  importStatements.push(`import Footer3 from './components/Footer3';`);
  componentContent.push('<Footer3 />');
  return zip.file('components/Footer3.jsx', content);
}

Footer3.craft = {
  props: {
    newsletterCategoryLabel: 'Newsletter',
    newsletterSignUpSubtitle:
