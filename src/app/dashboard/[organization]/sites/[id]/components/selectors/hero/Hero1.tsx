...
function SidebarDraggableItem({ hasActiveSub }: { hasActiveSub: boolean }) {
  return (
    <SidebarItem
      ...
      image="https://ablcaocvmgtcodafwvoe.supabase.co/storage/v1/object/public/components/hero_1-1699474655423.webp"
      name="Hero 1"
      Component={Hero1}
    />
  );
...
function prepForPageExport(
  ...
  importStatements.push(`import Hero1 from './components/Hero1';`);
  componentContent.push('<Hero1 />');
  return zip.file('components/Hero1.jsx', content);
}
