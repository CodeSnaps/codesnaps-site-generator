...
export const Hero1 = ({
  text = 'From Hero 1',
  description = 'This is a Hero 1 component',
  fontSize = 24,
}: {
  text?: string;
  description?: string;
...
function HeroSettings() {
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <button
        onClick={() => console.log(Hero1.craft.utils.componentString)}
...
function SidebarDraggable() {
  ...
  return (
    <div
      ref={(ref) => connectors.create(ref as HTMLElement, <Hero1 />)}
      className="p-4 bg-emerald-600"
    >
      <p>Hero 1</p>
    </div>
  );
