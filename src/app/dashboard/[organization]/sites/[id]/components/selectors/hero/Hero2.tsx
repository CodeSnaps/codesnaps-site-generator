...
function SidebarDraggableItem({ hasActiveSub }: { hasActiveSub: boolean }) {
  return (
    <SidebarItem
      ...
      image="https://ablcaocvmgtcodafwvoe.supabase.co/storage/v1/object/public/components/hero_2-1699474691473.webp"
      name="Hero 2"
      Component={Hero2}
    />
  );
...
function prepForPageExport(
  ...
  importStatements.push(`import Hero2 from './components/Hero2';`);
  componentContent.push('<Hero2 />');
  return zip.file('components/Hero2.jsx', content);
}
