...
export function SelectorsListSidebar({
  children,
  collapsed = false,
...
export function SelectorsListSidebarContent({
  children,
  className,
}: React.PropsWithChildren<{
  className?: string;
...
export function SelectorsListSidebarGroup({
  label,
  collapsed = false,
  collapsible = true,
  children,
...
export function SelectorsListSidebarDivider() {
  return (
    <div className={'border-t border-neutral-100 dark:border-dark-800 my-2'} />
  );
}

export function SelectorsListSidebarItem({
  end,
  path,
  children,
  Icon,
...
export default SelectorsListSidebar;
