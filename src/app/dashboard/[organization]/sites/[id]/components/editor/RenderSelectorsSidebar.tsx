...
export function RenderSelectorsSidebar({
  children,
  collapsed = false,
...
export function RenderSelectorsSidebarContent({
  children,
  className,
}: React.PropsWithChildren<{
  className?: string;
...
export function RenderSelectorsSidebarGroup({
  label,
  collapsed = false,
  collapsible = true,
  children,
...
export function RenderSelectorsSidebarDivider() {
  return (
...
export default RenderSelectorsSidebar;

function getClassNameBuilder() {
  return cva(
    [
      'absolute fixed box-content h-screen hidden flex-col border-r border-l border-neutral-200 bg-background lg:left-[12rem] lg:flex dark:border-dark-800 ' +
