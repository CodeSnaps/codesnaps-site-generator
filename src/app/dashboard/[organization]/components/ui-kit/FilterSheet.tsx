            ...
            {categories.map((category) => (
              <SheetClose asChild key={category.value}>
                <button
                  ...
                  className="underline text-base font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70 text-neutral-900 dark:text-neutral-100 hover:text-primary-600 dark:hover:text-primary-400 text-left"
                >
                  {category.name}
                </button>
              </SheetClose>
