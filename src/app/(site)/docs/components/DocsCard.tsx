...
> = ({ label, subtitle, children, link }) => {
  return (
    <div className="flex flex-col">
      ...
      {link && (
        <div className="rounded-b-2xl border border-primary-100 bg-primary-500/5 p-6 py-4 dark:border-primary-900/50 dark:bg-primary-900/20">
          <span className={'dark:text-primary-400 flex space-x-2 items-center'}>
            <Link
