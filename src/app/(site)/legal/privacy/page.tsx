  ...
  return (
    <div className="mx-auto flex justify-center">
      <div className="max-w-3xl flex flex-col space-y-4 my-14 px-4 lg:px-10 text-neutral-700 dark:text-neutral-300">
        ...
        <p>Last updated: November 07, 2023</p>
        <p>
        ...
        <h3 className="text-lg font-bold text-neutral-900 dark:text-neutral-100 lg:text-xl">
          Interpretation
        </h3>
        <p>
        ...
        <ul className="flex flex-col space-y-4">
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to CodeSnaps.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to CodeSnaps, accessible from{' '}
              <a
                href="https://www.codesnaps.io"
        ...
        <h4 className="text-base font-bold text-neutral-900 dark:text-neutral-100 lg:text-lg">
          Personal Data
        </h4>
        <p>
        ...
        <ul className="flex flex-col space-y-4">
          <li>By email: kaumon.business@gmail.com</li>
        </ul>
      </div>
    </div>
  );
