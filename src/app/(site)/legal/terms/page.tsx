    ...
    <div className="mx-auto flex justify-center">
      <div className="max-w-3xl flex flex-col space-y-4 my-14 px-4 lg:px-10 text-neutral-700 dark:text-neutral-300">
        ...
        <p>
          ...
          conditions. Do not continue to use CodeSnaps if you do not agree to
        ...
        <p>
          Unless otherwise stated, CodeSnaps and/or its licensors own the
          intellectual property rights for all material on CodeSnaps. All
          intellectual property rights are reserved. You may access this from
          CodeSnaps for your own personal use subjected to restrictions set in
          these terms and conditions.
        </p>

        <p>You must not:</p>
        <ul>
          <li className="ml-2">&middot; Republish material from CodeSnaps</li>
          <li className="ml-2">
            &middot; Sell, rent or sub-license material from CodeSnaps
          </li>
          <li className="ml-2">
            &middot; Reproduce, duplicate or copy material from CodeSnaps
          </li>
          <li className="ml-2">&middot; Redistribute content from CodeSnaps</li>
        </ul>
        ...
        <p>
          ...
          CodeSnaps does not filter, edit, publish or review Comments prior to
          their presence on the website. Comments do not reflect the views and
          opinions of CodeSnaps,its agents and/or affiliates. Comments reflect
          the views and opinions of the person who post their views and
          opinions. To the extent permitted by applicable laws, CodeSnaps shall
        ...
        <p>
          CodeSnaps reserves the right to monitor all Comments and to remove any
        ...
        <ul>
          <li className="ml-2">
            &middot; You are entitled to post the Comments on our website and
            have all necessary licenses and consents to do so;
          </li>
          <li className="ml-2">
            &middot; The Comments do not invade any intellectual property right,
            including without limitation copyright, patent or trademark of any
            third party;
          </li>
          <li className="ml-2">
            &middot; The Comments do not contain any defamatory, libelous,
            offensive, indecent or otherwise unlawful material which is an
            invasion of privacy
          </li>
          <li className="ml-2">
            &middot; The Comments will not be used to solicit or promote
        ...
        <p>
          You hereby grant CodeSnaps a non-exclusive license to use, reproduce,
        ...
        <ul>
          <li className="ml-2">&middot; Government agencies;</li>
          <li className="ml-2">&middot; Search engines;</li>
          <li className="ml-2">&middot; News organizations;</li>
          <li className="ml-2">
            &middot; Online directory distributors may link to our Website in
            the same manner as they hyperlink to the Websites of other listed
            businesses; and
          </li>
          <li className="ml-2">
            &middot; System wide Accredited Businesses except soliciting
        ...
        <ul>
          <li className="ml-2">
            &middot; commonly-known consumer and/or business information
            sources;
          </li>
          <li className="ml-2">&middot; dot.com community sites;</li>
          <li className="ml-2">
            &middot; associations or other groups representing charities;
          </li>
          <li className="ml-2">&middot; online directory distributors;</li>
          <li className="ml-2">&middot; internet portals;</li>
          <li className="ml-2">
            &middot; accounting, law and consulting firms; and
          </li>
          <li className="ml-2">
            &middot; educational institutions and trade associations.
          </li>
        </ul>
        ...
        <p>
          ...
          the hyperlink compensates the absence of CodeSnaps; and (d) the link
        ...
        <p>
          ...
          sending an e-mail to CodeSnaps. Please include your name, your
        ...
        <ul>
          <li className="ml-2">&middot; By use of our corporate name; or</li>
          <li className="ml-2">
            &middot; By use of the uniform resource locator being linked to; or
          </li>
          <li className="ml-2">
        ...
        <ul>
          <li className="ml-2">
            &middot; limit or exclude our or your liability for death or
            personal injury;
          </li>
          <li className="ml-2">
            &middot; limit or exclude our or your liability for fraud or
            fraudulent misrepresentation;
          </li>
          <li className="ml-2">
            &middot; limit any of our or your liabilities in any way that is not
            permitted under applicable law; or
          </li>
          <li className="ml-2">
            &middot; exclude any of our or your liabilities that may not be
